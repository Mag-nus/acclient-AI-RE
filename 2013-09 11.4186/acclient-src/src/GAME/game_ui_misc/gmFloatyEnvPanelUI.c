...
/* Module     : gmFloatyEnvPanelUI
   Object     : GAME\game_ui_misc\gmFloatyEnvPanelUI.obj
   Functions  : 24
   Addresses  : 004D47D0 - 006F46A0 */
...
//----- (004D47D0) --------------------------------------------------------  // acclient.c:260276
void __userpurge gmFloatyEnvPanelUI::gmFloatyEnvPanelUI(gmFloatyEnvPanelUI *this@<ecx>, int a2@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmFloatyEnvPanelUI *v4; // esi@1

  v4 = this;
  gmEnvPanelUI::gmEnvPanelUI((gmEnvPanelUI *)&this->vfptr, a2, _layout, _full_desc);
  v4->m_eWindowID = 0;
  v4->m_pTopBorder = 0;
  v4->m_pLeftBorder = 0;
  ...
  v4->vfptr = (IInputActionCallbackVtbl *)&gmFloatyEnvPanelUI::vftable;
  v4->vfptr = (NoticeHandlerVtbl *)&gmFloatyEnvPanelUI::vftable;
}
// 7BC3A8: using guessed type bool (__thiscall *gmFloatyEnvPanelUI::vftable)(DBCache *this);
// 7BC650: using guessed type int (__thiscall *gmFloatyEnvPanelUI::vftable)(void *, char);

//----- (004D4870) --------------------------------------------------------  // acclient.c:260306
gmFloatyEnvPanelUI *__thiscall gmFloatyEnvPanelUI::DynamicCast(gmFloatyEnvPanelUI *this, unsigned int i_eType)
{
  gmFloatyEnvPanelUI *result; // eax@1

  result = this;
  if ( i_eType != 268435534 && i_eType != 268435507 )
    result = (gmFloatyEnvPanelUI *)(i_eType != 3 ? 0 : (unsigned int)this);
  return result;
}

//----- (004D48A0) --------------------------------------------------------  // acclient.c:260317
signed int gmFloatyEnvPanelUI::GetUIElementType()
{
  return 268435534;
}

//----- (004D48B0) --------------------------------------------------------  // acclient.c:260323
void __usercall gmFloatyEnvPanelUI::Create(int a1@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmFloatyEnvPanelUI *v3; // eax@1

  v3 = (gmFloatyEnvPanelUI *)operator new(0x654u);
  if ( v3 )
    gmFloatyEnvPanelUI::gmFloatyEnvPanelUI(v3, a1, _layout, _full_desc);
}

//----- (004D48F0) --------------------------------------------------------  // acclient.c:260333
void __thiscall gmFloatyCombatPanelUI::UpdateLockedStatus(gmFloatyEnvPanelUI *this)
{
  gmFloatyEnvPanelUI *v1; // esi@1
...
//----- (004D4AC0) --------------------------------------------------------  // acclient.c:260387
gmFloatyEnvPanelUI *__thiscall gmFloatyEnvPanelUI::scalar_deleting_destructor(gmFloatyEnvPanelUI *this, unsigned int a2)
{
  gmFloatyEnvPanelUI *v2; // esi@1

  v2 = this;
  this->vfptr = (IInputActionCallbackVtbl *)&gmFloatyEnvPanelUI::vftable;
  this->vfptr = (NoticeHandlerVtbl *)&gmFloatyEnvPanelUI::vftable;
  gmEnvPanelUI::~gmEnvPanelUI((gmEnvPanelUI *)&this->vfptr);
  if ( a2 & 1 )
    operator delete(v2);
  return v2;
}
...
//----- (004D4AF0) --------------------------------------------------------  // acclient.c:260403
void __cdecl gmFloatyEnvPanelUI::Register()
{
  UIElement::RegisterElementClass(
    0x1000004Eu,
    (UIElement *(__cdecl *)(LayoutDesc *, ElementDesc *))gmFloatyEnvPanelUI::Create);
}

//----- (004D4B10) --------------------------------------------------------  // acclient.c:260411
void __thiscall gmFloatyEnvPanelUI::PostInit(gmFloatyEnvPanelUI *this)
{
  gmFloatyEnvPanelUI *v1; // esi@1
  UIElement *v2; // eax@1
  int v3; // eax@2
  ...
  ((void (__thiscall *)(gmFloatyEnvPanelUI *))v1->vfptr[26].__vecDelDtor)(v1);
}

//----- (004D4DE0) --------------------------------------------------------  // acclient.c:260567
void __thiscall gmFloatyCombatPanelUI::ListenToGlobalMessage(gmFloatyEnvPanelUI *this, unsigned int i_messageID, int i_data_int)
{
  PlayerModule *v3; // esi@1

  v3 = (PlayerModule *)this;
  if ( i_messageID == 13 )
    gmFloatyCombatPanelUI::UpdateLockedStatus(this);
  gmPanelUI::ListenToGlobalMessage(v3, (BaseProperty *)i_messageID, i_data_int);
}

//----- (004D4E10) --------------------------------------------------------  // acclient.c:260578
void __thiscall gmFloatyEnvPanelUI::UpdateFromPlayerModule(gmFloatyEnvPanelUI *this)
{
  gmFloatyEnvPanelUI *v1; // esi@1
  ...
  if ( v1->m_eWindowID && CPlayerSystem::GetPlayerSystem() && !CPlayerSystem::GetPlayerSystem()->m_layoutFromFile )
  {
    ...
    if ( PlayerModule::InqChatWindowOption(v2, v3, 0x10000086u, &propX)
      ...
      ((void (__thiscall *)(gmFloatyEnvPanelUI *, int, int))v1->vfptr[3].OnLoseFocus)(v1, h, w);
    v4 = v1->m_eWindowID;
    ...
    if ( PlayerModule::InqChatWindowOption(v2, v4, 0x10000088u, &propW)
      ...
      ((void (__thiscall *)(gmFloatyEnvPanelUI *, int, int))v1->vfptr[4].__vecDelDtor)(v1, w, h);
  ...
  gmFloatyCombatPanelUI::UpdateLockedStatus(v1);
...
//----- (004D5030) --------------------------------------------------------  // acclient.c:260656
void __userpurge gmFloatyEnvPanelUI::ResizeTo(gmFloatyEnvPanelUI *this@<ecx>, int a2@<edi>, const int i_width, const int i_height)
{
  gmFloatyEnvPanelUI *v4; // esi@1
  char *v5; // edi@1
  int v6; // ebx@1
  PlayerModule *v7; // edi@3
  int v8; // ebx@3
  BasePropertyDesc *v9; // ecx@6
  unsigned int v10; // edx@6
  BasePropertyValue *v11; // ecx@10
  ...
  BaseProperty propH; // [sp+10h] [bp-10h]@3
  BaseProperty propW; // [sp+18h] [bp-8h]@1
...
//----- (004D5190) --------------------------------------------------------  // acclient.c:260736
void __thiscall gmFloatyCombatPanelUI::MoveTo(gmFloatyEnvPanelUI *this, const int i_x, const int i_y)
{
  int v3; // ebx@1
  gmFloatyEnvPanelUI *v4; // esi@1
  int v5; // edi@1
  ...
  {
    v6 = (UIRegion *)((int (__thiscall *)(gmFloatyEnvPanelUI *))v4->vfptr[13].OnAction)(v4);
...
//----- (006F4590) --------------------------------------------------------  // acclient.c:776978
void sub_6F4590()
{
  outside_val_97 = 1000.0 + 1.0;
}

//----- (006F45B0) --------------------------------------------------------  // acclient.c:776984
void _E93_81()
{
  block_length_97 = 24.0 * 8.0;
}

//----- (006F45D0) --------------------------------------------------------  // acclient.c:776990
void _E95_81()
{
  half_square_length_97 = 24.0 * 0.5;
}

//----- (006F45F0) --------------------------------------------------------  // acclient.c:776996
int sub_6F45F0()
{
  return atexit(nullsub_661);
}

//----- (006F4600) --------------------------------------------------------  // acclient.c:777002
int sub_6F4600()
{
  return atexit(nullsub_662);
}

//----- (006F4610) --------------------------------------------------------  // acclient.c:777008
int _E103_91()
{
  return atexit(nullsub_663);
}

//----- (006F4620) --------------------------------------------------------  // acclient.c:777014
void _E106_64()
{
  DEFAULT_VIEW_RADIUS_66 = 0.00019999999 * 3.0 + 0.1;
}

//----- (006F4640) --------------------------------------------------------  // acclient.c:777020
void _E108_51()
{
  MIN_QUANTUM_66 = 1.0 / 30.0;
}

//----- (006F4660) --------------------------------------------------------  // acclient.c:777026
void _E110_42()
{
  MAX_QUANTUM_66 = 1.0 / 5.0;
}

//----- (006F4680) --------------------------------------------------------  // acclient.c:777032
void _E112_58()
{
  PixelFormatDesc::PixelFormatDesc(&stru_83FFD8, PFID_A8R8G8B8);
}

//----- (006F4690) --------------------------------------------------------  // acclient.c:777038
int _E117_43()
{
  return atexit(nullsub_659);
}

//----- (006F46A0) --------------------------------------------------------  // acclient.c:777044
int sub_6F46A0()
{
  return atexit(nullsub_660);
}
