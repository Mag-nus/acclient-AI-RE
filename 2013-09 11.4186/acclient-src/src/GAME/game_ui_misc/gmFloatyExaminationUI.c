...
/* Module     : gmFloatyExaminationUI
   Object     : GAME\game_ui_misc\gmFloatyExaminationUI.obj
   Functions  : 25
   Addresses  : 004D3BB0 - 006F4580 */
...
//----- (004D3BB0) --------------------------------------------------------  // acclient.c:259683
void __userpurge gmFloatyExaminationUI::gmFloatyExaminationUI(gmFloatyExaminationUI *this@<ecx>, int a2@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmFloatyExaminationUI *v4; // esi@1

  v4 = this;
  gmExaminationUI::gmExaminationUI((gmExaminationUI *)&this->vfptr, a2, _layout, _full_desc);
  v4->m_eWindowID = 0;
  v4->m_pTopBorder = 0;
  v4->m_pLeftBorder = 0;
  ...
  v4->vfptr = (IInputActionCallbackVtbl *)&gmFloatyExaminationUI::vftable;
  v4->vfptr = (NoticeHandlerVtbl *)&gmFloatyExaminationUI::vftable;
}
// 7BBED0: using guessed type bool (__thiscall *gmFloatyExaminationUI::vftable)(DBCache *this);
// 7BC178: using guessed type int (__thiscall *gmFloatyExaminationUI::vftable)(void *, char);

//----- (004D3C50) --------------------------------------------------------  // acclient.c:259713
gmFloatyExaminationUI *__thiscall gmFloatyExaminationUI::DynamicCast(gmFloatyExaminationUI *this, unsigned int i_eType)
{
  gmFloatyExaminationUI *result; // eax@1

  result = this;
  if ( i_eType != 268435532 && i_eType != 268435484 )
    result = (gmFloatyExaminationUI *)(i_eType != 3 ? 0 : (unsigned int)this);
  return result;
}

//----- (004D3C80) --------------------------------------------------------  // acclient.c:259724
signed int gmFloatyExaminationUI::GetUIElementType()
{
  return 268435532;
}

//----- (004D3C90) --------------------------------------------------------  // acclient.c:259730
void __usercall gmFloatyExaminationUI::Create(int a1@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmFloatyExaminationUI *v3; // eax@1

  v3 = (gmFloatyExaminationUI *)operator new(0x670u);
  if ( v3 )
    gmFloatyExaminationUI::gmFloatyExaminationUI(v3, a1, _layout, _full_desc);
}

//----- (004D3CC0) --------------------------------------------------------  // acclient.c:259740
UIElementMessageListenResult __thiscall gmFloatyExaminationUI::ListenToElementMessage(gmFloatyExaminationUI *this, UIElementMessageInfo *i_rMsg)
{
  gmExaminationUI *v2; // esi@1

  v2 = (gmExaminationUI *)this;
  if ( i_rMsg->idMessage == 1 && i_rMsg->idElement == 268436979 )
    ((void (__stdcall *)(_DWORD))this->vfptr[2].__vecDelDtor)(0);
  return gmExaminationUI::ListenToElementMessage(v2, i_rMsg);
}

//----- (004D3D00) --------------------------------------------------------  // acclient.c:259751
void __thiscall gmFloatyExaminationUI::UpdateLockedStatus(gmFloatyExaminationUI *this)
{
  gmFloatyExaminationUI *v1; // esi@1
...
//----- (004D3ED0) --------------------------------------------------------  // acclient.c:259805
gmFloatyExaminationUI *__thiscall gmFloatyExaminationUI::vector_deleting_destructor(gmFloatyExaminationUI *this, unsigned int a2)
{
  gmFloatyExaminationUI *v2; // esi@1

  v2 = this;
  this->vfptr = (IInputActionCallbackVtbl *)&gmFloatyExaminationUI::vftable;
  this->vfptr = (NoticeHandlerVtbl *)&gmFloatyExaminationUI::vftable;
  gmExaminationUI::~gmExaminationUI((gmExaminationUI *)&this->vfptr);
  if ( a2 & 1 )
    operator delete(v2);
  return v2;
}
...
//----- (004D3F00) --------------------------------------------------------  // acclient.c:259821
void __cdecl gmFloatyExaminationUI::Register()
{
  UIElement::RegisterElementClass(
    0x1000004Cu,
    (UIElement *(__cdecl *)(LayoutDesc *, ElementDesc *))gmFloatyExaminationUI::Create);
}

//----- (004D3F20) --------------------------------------------------------  // acclient.c:259829
void __thiscall gmFloatyExaminationUI::PostInit(gmFloatyExaminationUI *this)
{
  gmFloatyExaminationUI *v1; // esi@1
  UIElement *v2; // eax@1
  int v3; // eax@2
  ...
  if ( v34 )
  {
    v34->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v34, (unsigned int)&loc_4DD1E7, (NoticeHandler *)&v1->vfptr);
    v35->vfptr->RegisterNoticeHandler(
      (NoticeRegistrar *)v35,
      (unsigned int)((char *)&loc_4DD1EC + 1),
      (NoticeHandler *)&v1->vfptr);
    v35->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v35, (unsigned int)&loc_4DD1EE, (NoticeHandler *)&v1->vfptr);
    v35->vfptr->RegisterNoticeHandler(
      (NoticeRegistrar *)v35,
      (unsigned int)((char *)&loc_4DD1EE + 1),
      (NoticeHandler *)&v1->vfptr);
    v35->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v35, (unsigned int)&loc_4DD255, (NoticeHandler *)&v1->vfptr);
  ...
  ((void (__thiscall *)(gmFloatyExaminationUI *))v1->vfptr[26].__vecDelDtor)(v1);
}

//----- (004D4220) --------------------------------------------------------  // acclient.c:259989
void __thiscall gmFloatyExaminationUI::ListenToGlobalMessage(gmFloatyExaminationUI *this, unsigned int i_messageID, int i_data_int)
{
  gmExaminationUI *v3; // esi@1

  v3 = (gmExaminationUI *)this;
  if ( i_messageID == 13 )
    gmFloatyExaminationUI::UpdateLockedStatus(this);
  gmExaminationUI::ListenToGlobalMessage(v3, i_messageID, i_data_int);
}

//----- (004D4250) --------------------------------------------------------  // acclient.c:260000
void __thiscall gmFloatyExaminationUI::UpdateFromPlayerModule(gmFloatyExaminationUI *this)
{
  gmFloatyExaminationUI *v1; // esi@1
  ...
  if ( v1->m_eWindowID && CPlayerSystem::GetPlayerSystem() && !CPlayerSystem::GetPlayerSystem()->m_layoutFromFile )
  {
    ...
    if ( PlayerModule::InqChatWindowOption(v2, v3, 0x10000086u, &propX)
      ...
      ((void (__thiscall *)(gmFloatyExaminationUI *, int, int))v1->vfptr[3].OnLoseFocus)(v1, h, w);
    v4 = v1->m_eWindowID;
    ...
    if ( PlayerModule::InqChatWindowOption(v2, v4, 0x10000088u, &propW)
      ...
      ((void (__thiscall *)(gmFloatyExaminationUI *, int, int))v1->vfptr[4].__vecDelDtor)(v1, w, h);
  ...
  gmFloatyExaminationUI::UpdateLockedStatus(v1);
...
//----- (004D4470) --------------------------------------------------------  // acclient.c:260078
void __userpurge gmFloatyExaminationUI::ResizeTo(gmFloatyExaminationUI *this@<ecx>, int a2@<edi>, const int i_width, const int i_height)
{
  gmFloatyExaminationUI *v4; // esi@1
  char *v5; // edi@3
  int v6; // ebx@3
...
//----- (004D45E0) --------------------------------------------------------  // acclient.c:260161
void __thiscall gmFloatyExaminationUI::MoveTo(gmFloatyExaminationUI *this, const int i_x, const int i_y)
{
  int v3; // ebx@1
  gmFloatyExaminationUI *v4; // esi@1
  int v5; // edi@1
  ...
  {
    v6 = (UIRegion *)((int (__thiscall *)(gmFloatyExaminationUI *))v4->vfptr[13].OnAction)(v4);
...
//----- (006F4470) --------------------------------------------------------  // acclient.c:776906
void sub_6F4470()
{
  outside_val_96 = 1000.0 + 1.0;
}

//----- (006F4490) --------------------------------------------------------  // acclient.c:776912
void _E93_80()
{
  block_length_96 = 24.0 * 8.0;
}

//----- (006F44B0) --------------------------------------------------------  // acclient.c:776918
void _E95_80()
{
  half_square_length_96 = 24.0 * 0.5;
}

//----- (006F44D0) --------------------------------------------------------  // acclient.c:776924
int sub_6F44D0()
{
  return atexit(nullsub_666);
}

//----- (006F44E0) --------------------------------------------------------  // acclient.c:776930
int _E100_98()
{
  return atexit(nullsub_667);
}

//----- (006F44F0) --------------------------------------------------------  // acclient.c:776936
int _E103_90()
{
  return atexit(nullsub_668);
}

//----- (006F4500) --------------------------------------------------------  // acclient.c:776942
void _E106_63()
{
  DEFAULT_VIEW_RADIUS_65 = 0.00019999999 * 3.0 + 0.1;
}

//----- (006F4520) --------------------------------------------------------  // acclient.c:776948
void _E108_50()
{
  MIN_QUANTUM_65 = 1.0 / 30.0;
}

//----- (006F4540) --------------------------------------------------------  // acclient.c:776954
void _E110_41()
{
  MAX_QUANTUM_65 = 1.0 / 5.0;
}

//----- (006F4560) --------------------------------------------------------  // acclient.c:776960
void _E112_57()
{
  PixelFormatDesc::PixelFormatDesc(&stru_83FF60, PFID_A8R8G8B8);
}

//----- (006F4570) --------------------------------------------------------  // acclient.c:776966
int _E117_42()
{
  return atexit(nullsub_664);
}

//----- (006F4580) --------------------------------------------------------  // acclient.c:776972
int sub_6F4580()
{
  return atexit(nullsub_665);
}
