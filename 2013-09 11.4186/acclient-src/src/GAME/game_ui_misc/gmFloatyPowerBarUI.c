...
/* Module     : gmFloatyPowerBarUI
   Object     : GAME\game_ui_misc\gmFloatyPowerBarUI.obj
   Functions  : 26
   Addresses  : 004D0BC0 - 006F4100 */
...
//----- (004D0BC0) --------------------------------------------------------  // acclient.c:257342
void __userpurge gmFloatyPowerBarUI::gmFloatyPowerBarUI(gmFloatyPowerBarUI *this@<ecx>, int a2@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmFloatyPowerBarUI *v4; // esi@1

  v4 = this;
  gmPowerbarUI::gmPowerbarUI((gmPowerbarUI *)&this->vfptr, a2, _layout, _full_desc);
  v4->m_eWindowID = 0;
  v4->m_pTopBorder = 0;
  v4->m_pLeftBorder = 0;
  ...
  v4->vfptr = (IInputActionCallbackVtbl *)&gmFloatyPowerBarUI::vftable;
  v4->vfptr = (NoticeHandlerVtbl *)&gmFloatyPowerBarUI::vftable;
}
// 7BAB60: using guessed type bool (__thiscall *gmFloatyPowerBarUI::vftable)(DBCache *this);
// 7BAE08: using guessed type int (__thiscall *gmFloatyPowerBarUI::vftable)(void *, char);

//----- (004D0C60) --------------------------------------------------------  // acclient.c:257372
gmFloatyPowerBarUI *__thiscall gmFloatyPowerBarUI::DynamicCast(gmFloatyPowerBarUI *this, unsigned int i_eType)
{
  gmFloatyPowerBarUI *result; // eax@1

  result = this;
  if ( i_eType != 268435539 && i_eType != 268435471 )
    result = (gmFloatyPowerBarUI *)(i_eType != 3 ? 0 : (unsigned int)this);
  return result;
}

//----- (004D0C90) --------------------------------------------------------  // acclient.c:257383
signed int gmFloatyPowerBarUI::GetUIElementType()
{
  return 268435539;
}

//----- (004D0CA0) --------------------------------------------------------  // acclient.c:257389
void __usercall gmFloatyPowerBarUI::Create(int a1@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmFloatyPowerBarUI *v3; // eax@1

  v3 = (gmFloatyPowerBarUI *)operator new(0x648u);
  if ( v3 )
    gmFloatyPowerBarUI::gmFloatyPowerBarUI(v3, a1, _layout, _full_desc);
}

//----- (004D0CE0) --------------------------------------------------------  // acclient.c:257399
void __thiscall gmFloatyPowerBarUI::UpdateLockedStatus(gmFloatyPowerBarUI *this)
{
  gmFloatyPowerBarUI *v1; // esi@1
...
//----- (004D0EB0) --------------------------------------------------------  // acclient.c:257453
gmFloatyPowerBarUI *__thiscall gmFloatyPowerBarUI::vector_deleting_destructor(gmFloatyPowerBarUI *this, unsigned int a2)
{
  gmFloatyPowerBarUI *v2; // esi@1

  v2 = this;
  this->vfptr = (IInputActionCallbackVtbl *)&gmFloatyPowerBarUI::vftable;
  this->vfptr = (NoticeHandlerVtbl *)&gmFloatyPowerBarUI::vftable;
  gmPowerbarUI::~gmPowerbarUI((gmPowerbarUI *)&this->vfptr);
  if ( a2 & 1 )
    operator delete(v2);
  return v2;
}
...
//----- (004D0EE0) --------------------------------------------------------  // acclient.c:257469
void __cdecl gmFloatyPowerBarUI::Register()
{
  UIElement::RegisterElementClass(
    0x10000053u,
    (UIElement *(__cdecl *)(LayoutDesc *, ElementDesc *))gmFloatyPowerBarUI::Create);
}

//----- (004D0F00) --------------------------------------------------------  // acclient.c:257477
void __thiscall gmFloatyPowerBarUI::PostInit(gmFloatyPowerBarUI *this)
{
  gmFloatyPowerBarUI *v1; // esi@1
  UIElement *v2; // eax@1
  int v3; // eax@2
  ...
  if ( v34 )
  {
    v34->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v34, (unsigned int)&loc_4DD1FD, (NoticeHandler *)&v1->vfptr);
    ...
    v35->vfptr->RegisterNoticeHandler(
      (NoticeRegistrar *)v35,
      (unsigned int)((char *)&loc_4DD1FD + 1),
      (NoticeHandler *)&v1->vfptr);
    v35->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v35, 100017u, (NoticeHandler *)&v1->vfptr);
  ...
  ((void (__thiscall *)(gmFloatyPowerBarUI *))v1->vfptr[26].__vecDelDtor)(v1);
}

//----- (004D11F0) --------------------------------------------------------  // acclient.c:257635
void __thiscall gmFloatyPowerBarUI::ListenToGlobalMessage(gmFloatyPowerBarUI *this, unsigned int i_messageID, int i_data_int)
{
  if ( i_messageID == 13 )
    gmFloatyPowerBarUI::UpdateLockedStatus(this);
}

//----- (004D1200) --------------------------------------------------------  // acclient.c:257642
void __thiscall gmFloatyPowerBarUI::UpdateFromPlayerModule(gmFloatyPowerBarUI *this)
{
  gmFloatyPowerBarUI *v1; // esi@1
  ...
  if ( v1->m_eWindowID && CPlayerSystem::GetPlayerSystem() )
  {
    if ( !CPlayerSystem::GetPlayerSystem()->m_layoutFromFile )
    {
      ...
      if ( PlayerModule::InqChatWindowOption(v2, v3, 0x10000086u, &propX)
        ...
        ((void (__thiscall *)(gmFloatyPowerBarUI *, int, int))v1->vfptr[3].OnLoseFocus)(v1, bVis, w);
      v4 = v1->m_eWindowID;
      ...
      if ( PlayerModule::InqChatWindowOption(v2, v4, 0x10000088u, &propW)
        ...
        ((void (__thiscall *)(gmFloatyPowerBarUI *, int, int))v1->vfptr[4].__vecDelDtor)(v1, w, bVis);
  ...
  gmFloatyPowerBarUI::UpdateLockedStatus(v1);
...
//----- (004D1460) --------------------------------------------------------  // acclient.c:257727
void __userpurge gmFloatyPowerBarUI::ResizeTo(gmFloatyPowerBarUI *this@<ecx>, int a2@<edi>, const int i_width, const int i_height)
{
  gmFloatyPowerBarUI *v4; // esi@1
  char *v5; // edi@3
  int v6; // ebx@3
...
//----- (004D15D0) --------------------------------------------------------  // acclient.c:257810
void __thiscall gmFloatyPowerBarUI::MoveTo(gmFloatyPowerBarUI *this, const int i_x, const int i_y)
{
  int v3; // ebx@1
  gmFloatyPowerBarUI *v4; // esi@1
  int v5; // edi@1
  ...
  {
    v6 = (UIRegion *)((int (__thiscall *)(gmFloatyPowerBarUI *))v4->vfptr[13].OnAction)(v4);
...
//----- (004D17D0) --------------------------------------------------------  // acclient.c:257928
void __thiscall gmFloatyPowerBarUI::SetVisible(gmFloatyPowerBarUI *this, int i_fVisible)
{
  gmFloatyPowerBarUI *v2; // edi@1
  char *v3; // esi@3
...
//----- (004D6540) --------------------------------------------------------  // acclient.c:261906
void __thiscall gmFloatyPowerBarUI::RecvNotice_PlayerDescReceived(gmFloatyPowerBarUI *this, CACQualities *i_playerDesc, CPlayerModule *i_playerModule)
{
  ((void (__thiscall *)(_DWORD))this[-1].m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[17][39].m_hashKey)(&this[-1].m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[17]);
}

//----- (006F3FF0) --------------------------------------------------------  // acclient.c:776618
void sub_6F3FF0()
{
  outside_val_92 = 1000.0 + 1.0;
}

//----- (006F4010) --------------------------------------------------------  // acclient.c:776624
void _E93_76()
{
  block_length_92 = 24.0 * 8.0;
}

//----- (006F4030) --------------------------------------------------------  // acclient.c:776630
void _E95_76()
{
  half_square_length_92 = 24.0 * 0.5;
}

//----- (006F4050) --------------------------------------------------------  // acclient.c:776636
int sub_6F4050()
{
  return atexit(nullsub_686);
}

//----- (006F4060) --------------------------------------------------------  // acclient.c:776642
int _E100_94()
{
  return atexit(nullsub_687);
}

//----- (006F4070) --------------------------------------------------------  // acclient.c:776648
int _E103_86()
{
  return atexit(nullsub_688);
}

//----- (006F4080) --------------------------------------------------------  // acclient.c:776654
void _E106_59()
{
  DEFAULT_VIEW_RADIUS_61 = 0.00019999999 * 3.0 + 0.1;
}

//----- (006F40A0) --------------------------------------------------------  // acclient.c:776660
void _E108_46()
{
  MIN_QUANTUM_61 = 1.0 / 30.0;
}

//----- (006F40C0) --------------------------------------------------------  // acclient.c:776666
void _E110_37()
{
  MAX_QUANTUM_61 = 1.0 / 5.0;
}

//----- (006F40E0) --------------------------------------------------------  // acclient.c:776672
void _E112_53()
{
  PixelFormatDesc::PixelFormatDesc(&PixelFormatDesc_A8R8G8B8_96, PFID_A8R8G8B8);
}

//----- (006F40F0) --------------------------------------------------------  // acclient.c:776678
int _E117_38()
{
  return atexit(nullsub_684);
}

//----- (006F4100) --------------------------------------------------------  // acclient.c:776684
int sub_6F4100()
{
  return atexit(nullsub_685);
}
