...
/* Module     : gmExaminationUI
   Object     : GAME\game_ui_misc\gmExaminationUI.obj
   Functions  : 119
   Addresses  : 004AB1B0 - 00761190 */
...
//----- (004AB1B0) --------------------------------------------------------  // acclient.c:226472
void __thiscall ExamineSubUI::Init(ExamineSubUI *this, unsigned int _objid, ACCWeenieObject *weenObj)
{
  this->cur_objid = _objid;
  this->cur_weenobj = weenObj;
}

//----- (004AB1D0) --------------------------------------------------------  // acclient.c:226479
char *__cdecl ModifierToString(long double rMod)
{
  ...
  if ( 1.0 - rMod < 0.0 )
    v1 = -v1;
  _sprintf(g_szPecentText, "%c%d%%", (char)(2 * (rMod < 1.0) + 43), (unsigned __int64)(v1 * 100.0 + 0.5));
  return g_szPecentText;
}

//----- (004AB240) --------------------------------------------------------  // acclient.c:226491
char *__cdecl SmallModifierToString(long double rMod)
{
  long double v1; // st7@1
  ...
  if ( 1.0 - rMod < 0.0 )
    v1 = -v1;
  _sprintf(g_szPecentText, "%c%.1lf%%", (char)(2 * (rMod < 1.0) + 43), v1 * 100.0);
  return g_szPecentText;
}

//----- (004AB2B0) --------------------------------------------------------  // acclient.c:226503
void __userpurge gmExaminationUI::gmExaminationUI(gmExaminationUI *this@<ecx>, int a2@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmExaminationUI *v4; // esi@1
  ...
  v4->vfptr = (IInputActionCallbackVtbl *)&gmExaminationUI::vftable;
  v4->vfptr = (NoticeHandlerVtbl *)&gmExaminationUI::vftable;
  v4->m_examineNewlySelectedItem = 1;
}
// 7AEF08: using guessed type bool (__thiscall *gmExaminationUI::vftable)(DBCache *this);
// 7AF1B0: using guessed type int (__thiscall *gmExaminationUI::vftable)(void *, char);
// 7BF328: using guessed type bool (__thiscall *ClientHousingSystem::vftable)(DBCache *this);

//----- (004AB330) --------------------------------------------------------  // acclient.c:226529
gmExaminationUI *__thiscall gmExaminationUI::DynamicCast(gmExaminationUI *this, unsigned int i_eType)
{
  gmExaminationUI *result; // eax@1

  result = this;
  if ( i_eType != 268435484 )
    result = (gmExaminationUI *)(i_eType != 3 ? 0 : (unsigned int)this);
  return result;
}

//----- (004AB350) --------------------------------------------------------  // acclient.c:226540
signed int gmExaminationUI::GetUIElementType()
{
  return 268435484;
}

//----- (004AB360) --------------------------------------------------------  // acclient.c:226546
void __usercall gmExaminationUI::Create(int a1@<edi>, LayoutDesc *_layout, ElementDesc *_full_desc)
{
  gmExaminationUI *v3; // eax@1

  v3 = (gmExaminationUI *)operator new(0x628u);
  if ( v3 )
    gmExaminationUI::gmExaminationUI(v3, a1, _layout, _full_desc);
}

//----- (004AB390) --------------------------------------------------------  // acclient.c:226556
bool __thiscall gmExaminationUI::OnChildAction(gmExaminationUI *this, UIElement *i_pChild, InputEvent *i_evt)
{
  bool result; // al@4

  if ( i_evt->m_fStart
    && (UIElement_Text *)i_pChild == this->m_itemUI->m_itemInscriptionText
    && i_evt->m_InputAction == 268435492 )
    result = 0;
  else
    result = UIElement::OnChildAction((UIElement *)&this->vfptr, i_pChild, i_evt);
  return result;
}

//----- (004AB3D0) --------------------------------------------------------  // acclient.c:226570
void __thiscall gmExaminationUI::RecvNotice_SelectionChanged(gmExaminationUI *this)
{
  gmExaminationUI *v1; // esi@1
  char *v2; // edi@1
  unsigned int v3; // ST00_4@4
  ClientUISystem *v4; // eax@4

  v1 = this;
  v2 = (char *)&this[-1].m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[9];
  if ( UIElement::IsVisible((UIElement *)&this[-1].m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[9])
    && LOBYTE(v1->m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[6]) )
  {
    if ( ACCWeenieObject::selectedID )
    {
      v3 = ACCWeenieObject::selectedID;
      v4 = ClientUISystem::GetUISystem();
      ClientUISystem::ExamineObject(v4, v3);
    }
    else
    {
...
//----- (004AB420) --------------------------------------------------------  // acclient.c:226596
void __thiscall gmExaminationUI::SetActiveExamineUI(gmExaminationUI *this, ExamineSubUI *ui)
{
  gmExaminationUI *v2; // esi@1
  ExamineSubUI *v3; // ecx@1

  v2 = this;
  v3 = (ExamineSubUI *)&this->m_itemUI->vfptr;
  v2->m_activeUI = ui;
  if ( ui == v3 )
  {
    ((void (__stdcall *)(_DWORD))v2->m_creatureUI->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_charUI->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_spellUI->vfptr->Show)(0);
    ((void (__stdcall *)(signed int))v2->m_itemUI->vfptr->Show)(1);
  }
  else if ( (CreatureExamineUI *)ui == v2->m_creatureUI )
  {
    ((void (__stdcall *)(_DWORD))v3->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_charUI->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_spellUI->vfptr->Show)(0);
    ((void (__stdcall *)(signed int))v2->m_creatureUI->vfptr->Show)(1);
  }
  else if ( (CharExamineUI *)ui == v2->m_charUI )
  {
    ((void (__stdcall *)(_DWORD))v3->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_creatureUI->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_spellUI->vfptr->Show)(0);
    ((void (__stdcall *)(signed int))v2->m_charUI->vfptr->Show)(1);
  }
  else if ( (SpellExamineUI *)ui == v2->m_spellUI )
  {
    ((void (__stdcall *)(_DWORD))v3->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_creatureUI->vfptr->Show)(0);
    ((void (__stdcall *)(_DWORD))v2->m_charUI->vfptr->Show)(0);
    ((void (__stdcall *)(signed int))v2->m_spellUI->vfptr->Show)(1);
  }
}

//----- (004AB530) --------------------------------------------------------  // acclient.c:226635
void __thiscall gmExaminationUI::UseTime(gmExaminationUI *this)
{
  gmExaminationUI *v1; // esi@1
  ExamineSubUI *v2; // eax@4
  ...
  {
    v2 = v1->m_activeUI;
    if ( (CreatureExamineUI *)v2 == v1->m_creatureUI || (CharExamineUI *)v2 == v1->m_charUI )
    {
      if ( v1->current_appraisal_ID )
        CM_Item::Event_Appraise(v1->current_appraisal_ID);
    }
    v1->m_timeNextUpdate = COERCE_DOUBLE(Timer::cur_time.Cmd) + 0.75;
  }
}

//----- (004AB5A0) --------------------------------------------------------  // acclient.c:226656
void __thiscall CreatureExamineUI::Show(CreatureExamineUI *this, int shown)
{
  CreatureExamineUI *v2; // esi@1
  UIElement *v3; // ecx@1
  UIElement *v4; // ecx@3

  v2 = this;
  v3 = this->m_basicCreatureExamineBaseField;
  if ( v3 )
    ((void (__stdcall *)(_DWORD))v3->vfptr[2].__vecDelDtor)(shown);
  v4 = v2->m_creatureInfoSubPanel;
  if ( v4 )
    ((void (__stdcall *)(_DWORD))v4->vfptr[2].__vecDelDtor)(shown);
}

//----- (004AB5D0) --------------------------------------------------------  // acclient.c:226672
void __thiscall CharExamineUI::Show(CharExamineUI *this, int shown)
{
  CharExamineUI *v2; // esi@1
  UIElement *v3; // ecx@1
  UIElement *v4; // ecx@3
  ...
  if ( v3 )
    ((void (__stdcall *)(_DWORD))v3->vfptr[2].__vecDelDtor)(shown);
  v4 = v2->m_characterInfoSubPanel;
  if ( v4 )
    ((void (__stdcall *)(_DWORD))v4->vfptr[2].__vecDelDtor)(shown);
}

//----- (004AB600) --------------------------------------------------------  // acclient.c:226688
void __thiscall ItemExamineUI::Show(SpellExamineUI *this, int shown)
{
  UIElement *v2; // ecx@1

  v2 = this->m_spellExamineBaseField;
  if ( v2 )
    ((void (__stdcall *)(_DWORD))v2->vfptr[2].__vecDelDtor)(shown);
}

//----- (004AB610) --------------------------------------------------------  // acclient.c:226698
void __thiscall AC1Legacy::PStringBase<char>::clear(AC1Legacy::PStringBase<char> *this)
{
  AC1Legacy::PStringBase<char> *v1; // edi@1
  ...
  if ( this->m_buffer != (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer )
  {
    ...
    v1->m_buffer = (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
    InterlockedIncrement(v3);
  }
}
// 8EE10C: using guessed type int AC1Legacy::PStringBase<char>::s_NullBuffer;

//----- (004AB650) --------------------------------------------------------  // acclient.c:226721
bool __thiscall AC1Legacy::PStringBase<char>::operator==(AC1Legacy::PStringBase<char> *this, AC1Legacy::PStringBase<char> *rhs)
{
  return strcmp(this->m_buffer->m_data, rhs->m_buffer->m_data) == 0;
}

//----- (004AB6B0) --------------------------------------------------------  // acclient.c:226727
bool __thiscall AC1Legacy::PStringBase<char>::operator!=(AC1Legacy::PStringBase<char> *this, AC1Legacy::PStringBase<char> *rhs)
{
  return strcmp(this->m_buffer->m_data, rhs->m_buffer->m_data) != 0;
}

//----- (004AB710) --------------------------------------------------------  // acclient.c:226733
int __thiscall AC1Legacy::PStringBase<char>::cmp(AC1Legacy::PStringBase<char> *this, AC1Legacy::PStringBase<char> *rhs, int case_sensitive)
{
  int result; // eax@2

  if ( case_sensitive )
    result = strcmp(this->m_buffer->m_data, rhs->m_buffer->m_data);
  else
    result = __stricmp(this->m_buffer->m_data, rhs->m_buffer->m_data);
  return result;
}

//----- (004AB780) --------------------------------------------------------  // acclient.c:226745
void __cdecl gmExaminationUI::Register()
{
  UIElement::RegisterElementClass(
    0x1000001Cu,
    (UIElement *(__cdecl *)(LayoutDesc *, ElementDesc *))gmExaminationUI::Create);
}

//----- (004AB7A0) --------------------------------------------------------  // acclient.c:226753
void __thiscall gmExaminationUI::ListenToGlobalMessage(gmExaminationUI *this, unsigned int i_messageID, int i_data_int)
{
  if ( i_messageID == 3 )
    gmExaminationUI::UseTime(this);
}

//----- (004AB7B0) --------------------------------------------------------  // acclient.c:226760
void __thiscall gmExaminationUI::RecvNotice_ExamineObject(gmExaminationUI *this, unsigned int i_objid)
{
  gmExaminationUI *v2; // esi@1
  ...
  if ( i_objid )
  {
    if ( !this->m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[4] )
    {
      v3 = ClientUISystem::GetUISystem();
      ClientUISystem::IncrementBusyCount(v3);
    }
    v2->m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[4] = (HashSetData<UIElement *> *)i_objid;
    CM_Item::Event_Appraise(i_objid);
    v2->m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[5] = 0;
  }
}

//----- (004AB7F0) --------------------------------------------------------  // acclient.c:226780
void __thiscall ItemExamineUI::ItemExamineUI(ItemExamineUI *this, gmExaminationUI *_parentElement)
{
  ...
  v2 = this;
  this->vfptr = (ExamineSubUIVtbl *)&ExamineSubUI::vftable;
  this->cur_objid = 0;
  this->cur_weenobj = 0;
  AppraisalProfile::AppraisalProfile(&this->cur_prof);
  v2->m_pParentElement = _parentElement;
  v2->vfptr = (ExamineSubUIVtbl *)&ItemExamineUI::vftable;
  v2->m_itemExamineBaseField = 0;
  v2->m_itemValueText = 0;
  v2->m_itemBurdenText = 0;
  v2->m_itemDisplayText = 0;
  v2->m_itemInscriptionText = 0;
  v2->m_itemInscriptionSignatureText = 0;
  v2->m_itemInscriptionBackground = 0;
  v2->m_itemIcon = 0;
  v3 = (volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4);
  v2->m_scribe_name.m_buffer = (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
  InterlockedIncrement(v3);
  v4 = (volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4);
  v2->m_scribe_account.m_buffer = (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
  InterlockedIncrement(v4);
  v5 = (volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4);
  v2->m_old_inscription.m_buffer = (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
  InterlockedIncrement(v5);
  v6 = (UIElement *)&v2->m_pParentElement->vfptr;
  if ( v6 )
    v2->m_itemExamineBaseField = UIElement::GetChildRecursive(v6, 0x1000012Eu);
  v7 = v2->m_itemExamineBaseField;
  if ( v7 )
  {
    v8 = UIElement::GetChildRecursive(v7, 0x10000138u);
    v9 = v2->m_itemExamineBaseField;
    v2->m_itemValueText = (UIElement_Text *)v8;
    v10 = UIElement::GetChildRecursive(v9, 0x10000139u);
    v11 = v2->m_itemExamineBaseField;
    v2->m_itemBurdenText = (UIElement_Text *)v10;
    v12 = UIElement::GetChildRecursive(v11, 0x1000013Au);
    v13 = v2->m_itemExamineBaseField;
    v2->m_itemIcon = v12;
    v14 = UIElement::GetChildRecursive(v13, 0x1000013Cu);
    v15 = v2->m_itemExamineBaseField;
    v2->m_itemDisplayText = (UIElement_Text *)v14;
    v16 = UIElement::GetChildRecursive(v15, 0x1000013Eu);
    v17 = v2->m_itemExamineBaseField;
    v2->m_itemInscriptionText = (UIElement_Text *)v16;
    v18 = UIElement::GetChildRecursive(v17, 0x1000013Fu);
    v19 = v2->m_itemExamineBaseField;
    v2->m_itemInscriptionSignatureText = (UIElement_Text *)v18;
    v2->m_itemInscriptionBackground = UIElement::GetChildRecursive(v19, 0x10000137u);
  }
  v2->mod_high_font = 1;
  v2->mod_low_font = 2;
}
// 7AF2F0: using guessed type void (__thiscall *ExamineSubUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);
// 7AF310: using guessed type void (__thiscall *ItemExamineUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);
// 8EE10C: using guessed type int AC1Legacy::PStringBase<char>::s_NullBuffer;

//----- (004AB940) --------------------------------------------------------  // acclient.c:226859
void __thiscall ItemExamineUI::~ItemExamineUI(ItemExamineUI *this)
{
  ItemExamineUI *v1; // esi@1
  AC1Legacy::PSRefBuffer<char> *v2; // edi@1
  AC1Legacy::PSRefBuffer<char> *v3; // edi@4
  AC1Legacy::PSRefBuffer<char> *v4; // edi@7

  v1 = this;
  v2 = this->m_old_inscription.m_buffer;
  this->vfptr = (ExamineSubUIVtbl *)&ItemExamineUI::vftable;
  if ( !InterlockedDecrement((volatile LONG *)&v2->m_cRef) && v2 )
    v2->vfptr->__vecDelDtor((ReferenceCountTemplate<268435456,0> *)v2, 1u);
  v3 = v1->m_scribe_account.m_buffer;
  if ( !InterlockedDecrement((volatile LONG *)&v3->m_cRef) && v3 )
    v3->vfptr->__vecDelDtor((ReferenceCountTemplate<268435456,0> *)v3, 1u);
  v4 = v1->m_scribe_name.m_buffer;
  if ( !InterlockedDecrement((volatile LONG *)&v4->m_cRef) && v4 )
    v4->vfptr->__vecDelDtor((ReferenceCountTemplate<268435456,0> *)v4, 1u);
  v1->vfptr = (ExamineSubUIVtbl *)&ExamineSubUI::vftable;
  AppraisalProfile::~AppraisalProfile(&v1->cur_prof);
}
// 7AF2F0: using guessed type void (__thiscall *ExamineSubUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);
// 7AF310: using guessed type void (__thiscall *ItemExamineUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);

//----- (004AB9C0) --------------------------------------------------------  // acclient.c:226884
void __thiscall BasicCreatureExamineUI::Init(BasicCreatureExamineUI *this, unsigned int _objid, ACCWeenieObject *weenObj)
{
  BasicCreatureExamineUI *v3; // esi@1
  UIElement_Viewport *v4; // ecx@1
  CPhysicsObj *v5; // ecx@1
  HashBaseData<unsigned long> *v6; // eax@3
  CPhysicsObj *v7; // eax@4
  double v8; // st6@6
  UIElement_Viewport *v9; // ecx@8
  float v10; // [sp+8h] [bp-3Ch]@5
  float v11; // [sp+Ch] [bp-38h]@5
  float v12; // [sp+10h] [bp-34h]@5
  Vector3 vCameraPos; // [sp+14h] [bp-30h]@1
  Vector3 vCameraDirection; // [sp+20h] [bp-24h]@8
  BBox bounds; // [sp+2Ch] [bp-18h]@5
  float _objida; // [sp+48h] [bp+4h]@5
  unsigned int _objidb; // [sp+48h] [bp+4h]@8
  float rRequiredCameraDistance; // [sp+4Ch] [bp+8h]@5

  v3 = this;
  v4 = this->m_pPaperDoll;
  v3->cur_objid = _objid;
  v3->cur_weenobj = weenObj;
  LODWORD(vCameraPos.x) = 1050253722;
  LODWORD(vCameraPos.y) = 1072902963;
  LODWORD(vCameraPos.z) = 1059481190;
  UIElement_Viewport::SetLight(v4, DISTANT_LIGHT, 2.0, &vCameraPos);
  CreatureMode::RemoveAllObjects((CreatureMode *)&v3->m_pPaperDoll->creature_mode_objects);
  v5 = v3->m_p3DObj;
  if ( v5 )
    ((void (__stdcall *)(signed int))v5->vfptr->__vecDelDtor)(1);
  v3->m_p3DObj = 0;
  v6 = ClientObjMaintSystem::GetPhysicsObject(_objid);
  if ( v6 )
  {
    v7 = CPhysicsObj::makeObject((CPhysicsObj *)v6);
    v3->m_p3DObj = v7;
    if ( v7 )
    {
      CPhysicsObj::set_heading(v7, 191.3679, 1);
      bounds.m_vMin = Legacy_Vector3_ZeroVector___85.0;
      bounds.m_vMax = Legacy_Vector3_ZeroVector___85.0;
      CPhysicsObj::GetBoundingBox(v3->m_p3DObj, &bounds);
      v10 = bounds.m_vMax.x - bounds.m_vMin.x;
      v11 = bounds.m_vMax.y - bounds.m_vMin.y;
      v12 = bounds.m_vMax.z - bounds.m_vMin.z;
      rRequiredCameraDistance = (double)UIRegion::GetWidth((UIRegion *)&v3->m_pPaperDoll->vfptr);
      _objida = (double)UIRegion::GetHeight((UIRegion *)&v3->m_pPaperDoll->vfptr) / rRequiredCameraDistance;
      if ( v12 / v10 >= _objida )
        v8 = v12;
      else
        v8 = v10 * _objida;
      *(float *)&_objidb = v8 * 1.2071068 + v11 * 0.5;
      BBox::GetCenter(&bounds, &vCameraPos);
      v9 = v3->m_pPaperDoll;
      vCameraPos.y = vCameraPos.y - *(float *)&_objidb;
      LODWORD(vCameraDirection.x) = 0;
      LODWORD(vCameraDirection.y) = 0;
      LODWORD(vCameraDirection.z) = 0;
      UIElement_Viewport::SetCamera(v9, &vCameraPos, &vCameraDirection);
      CreatureMode::AddObject((CreatureMode *)&v3->m_pPaperDoll->creature_mode_objects, v3->m_p3DObj);
    }
  }
}

//----- (004ABBB0) --------------------------------------------------------  // acclient.c:226950
void __thiscall BasicCreatureExamineUI::AddLineToMiscInfo(BasicCreatureExamineUI *this, PStringBase<unsigned short> *_label, PStringBase<unsigned short> *_value, int _colorIndex)
{
  UIElement_ListBox *v4; // ecx@1
  int v5; // eax@2
  UIElement *v6; // esi@2
  UIElement *v7; // eax@3
  UIElement_Text *v8; // edi@4
  UIElement *v9; // eax@6
  UIElement_Text *v10; // esi@7

  v4 = this->m_extraInfoList;
  if ( v4 )
  {
    v5 = UIElement_ListBox::AddItemFromTemplateList(v4, 0, 0);
    v6 = (UIElement *)v5;
    if ( v5 )
    {
      v7 = UIElement::GetChildRecursive((UIElement *)v5, 0x1000012Au);
      if ( v7 )
        v8 = (UIElement_Text *)v7->vfptr[12].OnAction((IInputActionCallback *)v7, (InputEvent *)12);
      else
        v8 = 0;
      v9 = UIElement::GetChildRecursive(v6, 0x1000012Bu);
      if ( v9 )
        v10 = (UIElement_Text *)v9->vfptr[12].OnAction((IInputActionCallback *)v9, (InputEvent *)12);
      else
        v10 = 0;
      if ( v8 )
        UIElement_Text::SetTextWithFont(v8, _label, 0, _colorIndex);
      if ( v10 )
        UIElement_Text::SetTextWithFont(v10, _value, 0, _colorIndex);
    }
  }
}

//----- (004ABC50) --------------------------------------------------------  // acclient.c:226986
void __thiscall SpellExamineUI::SpellExamineUI(SpellExamineUI *this, gmExaminationUI *_parentElement)
{
  SpellExamineUI *v2; // esi@1
  UIElement *v3; // ecx@3
  UIElement *v4; // eax@4
  int v5; // eax@5
  UIElement *v6; // ecx@7
  ...
  int v11; // eax@11
  UIElement *v12; // ecx@13
  UIElement *v13; // eax@13
  int v14; // eax@14
  UIElement *v15; // ecx@16
  UIElement *v16; // eax@16
  int v17; // eax@17
  UIElement *v18; // ecx@19
  UIElement *v19; // eax@19
  UIElement *v20; // ecx@19
  UIElement *v21; // eax@19
  int v22; // eax@20
  ...
  AppraisalProfile::AppraisalProfile(&this->cur_prof);
  v2->m_pParentElement = _parentElement;
  v2->vfptr = (ExamineSubUIVtbl *)&SpellExamineUI::vftable;
  v2->m_spellExamineBaseField = 0;
  v2->m_magicSchoolText = 0;
  v2->m_spellManaText = 0;
  v2->m_spellRangeText = 0;
  v2->m_spellDurationText = 0;
  v2->m_spellDisplayText = 0;
  v2->m_spellIcon = 0;
  v2->m_formulaListBox = 0;
  v2->cur_spellid = 0;
  v2->m_componentListX = 32;
  v2->m_componentListW = 32;
  if ( _parentElement )
    v2->m_spellExamineBaseField = UIElement::GetChildRecursive((UIElement *)&_parentElement->vfptr, 0x10000153u);
  v3 = v2->m_spellExamineBaseField;
  if ( v3 )
  {
    v4 = UIElement::GetChildRecursive(v3, 0x1000015Eu);
    if ( v4 )
      v5 = v4->vfptr[12].OnAction((IInputActionCallback *)v4, (InputEvent *)12);
    else
      v5 = 0;
    v6 = v2->m_spellExamineBaseField;
    v2->m_magicSchoolText = (UIElement_Text *)v5;
    v7 = UIElement::GetChildRecursive(v6, 0x10000160u);
    if ( v7 )
      v8 = v7->vfptr[12].OnAction((IInputActionCallback *)v7, (InputEvent *)12);
    else
      v8 = 0;
    v9 = v2->m_spellExamineBaseField;
    v2->m_spellManaText = (UIElement_Text *)v8;
    v10 = UIElement::GetChildRecursive(v9, 0x10000162u);
    if ( v10 )
      v11 = v10->vfptr[12].OnAction((IInputActionCallback *)v10, (InputEvent *)12);
    else
      v11 = 0;
    v12 = v2->m_spellExamineBaseField;
    v2->m_spellRangeText = (UIElement_Text *)v11;
    v13 = UIElement::GetChildRecursive(v12, 0x10000161u);
    if ( v13 )
      v14 = v13->vfptr[12].OnAction((IInputActionCallback *)v13, (InputEvent *)12);
    else
      v14 = 0;
    v15 = v2->m_spellExamineBaseField;
    v2->m_spellDurationText = (UIElement_Text *)v14;
    v16 = UIElement::GetChildRecursive(v15, 0x10000163u);
    if ( v16 )
      v17 = v16->vfptr[12].OnAction((IInputActionCallback *)v16, (InputEvent *)12);
    else
      v17 = 0;
    v18 = v2->m_spellExamineBaseField;
    v2->m_spellDisplayText = (UIElement_Text *)v17;
    v19 = UIElement::GetChildRecursive(v18, 0x1000015Fu);
    v20 = v2->m_spellExamineBaseField;
    v2->m_spellIcon = v19;
    v21 = UIElement::GetChildRecursive(v20, 0x1000032Du);
    if ( v21 )
      v22 = v21->vfptr[12].OnAction((IInputActionCallback *)v21, (InputEvent *)5);
    else
      v22 = 0;
    v2->m_formulaListBox = (UIElement_ListBox *)v22;
    if ( v22 )
    {
      v2->m_componentListX = *(_DWORD *)(v22 + 124);
      v2->m_componentListW = UIRegion::GetWidth((UIRegion *)v22);
    }
  }
}
// 7AF2F0: using guessed type void (__thiscall *ExamineSubUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);
// 7AF320: using guessed type void (__thiscall *SpellExamineUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);

//----- (004ABDF0) --------------------------------------------------------  // acclient.c:227088
void __thiscall SpellExamineUI::ClearIcons(SpellExamineUI *this)
{
  SpellExamineUI *v1; // esi@1
  UIElement_ListBox *v2; // ecx@1
  unsigned int i; // eax@1

  v1 = this;
  v2 = this->m_formulaListBox;
  for ( i = v2->m_listItems.m_num; (signed int)i > 0; i = v2->m_listItems.m_num )
  {
    UIElement_ListBox::DeleteItem(v2, i - 1);
    v2 = v1->m_formulaListBox;
  }
}

//----- (004ABE20) --------------------------------------------------------  // acclient.c:227104
void __userpurge SpellExamineUI::UpdateComponents(SpellExamineUI *this@<ecx>, signed int a2@<edi>, ComponentTrackerUpdate _change)
{
  ...
  UIElement *v6; // esi@4
  UIElement *v7; // edi@5
  IInputActionCallbackVtbl *v8; // eax@6
  CPlayerSystem *v9; // eax@9
  ComponentTracker *v10; // eax@9
  ComponentTracker *v11; // esi@9
  IDClass<_tagDataID,32,0> *v12; // eax@10
  BasePropertyDesc *v13; // ecx@14
  unsigned int v14; // edx@14
  BasePropertyValue *v15; // ecx@18
  unsigned int v16; // edx@18
  signed int v17; // [sp+4h] [bp-24h]@3
  unsigned int v18; // [sp+18h] [bp-10h]@1
  BaseProperty scidProp; // [sp+20h] [bp-8h]@6
  void *retaddr; // [sp+28h] [bp+0h]@7

  v18 = (unsigned int)this;
  v3 = this->m_formulaListBox;
  if ( v3 )
  {
    v4 = 0;
    if ( (signed int)v3->m_listItems.m_num > 0 )
    {
      ...
      do
      {
        ...
        if ( v5 )
        {
          v7 = UIElement::GetChildRecursive(v5, 0x10000330u);
          if ( v7 )
          {
            v8 = v6->vfptr;
            scidProp.m_pcPropertyDesc = 0;
            scidProp.m_pcPropertyValue = 0;
            if ( (unsigned __int8)((int (__thiscall *)(UIElement *, signed int, BaseProperty *, signed int))v8[17].OnAction)(
                                    v6,
                                    268435472,
                                    &scidProp,
                                    v17)
              && retaddr )
              (*(void (__stdcall **)(unsigned int *))(*(_DWORD *)retaddr + 120))(&v18);
            v9 = CPlayerSystem::GetPlayerSystem();
            CPlayerSystem::GetComponentTracker(v9);
            v11 = v10;
            if ( v10
              && (v12 = SpellComponentTable::SCIDtoWCID((IDClass<_tagDataID,32,0> *)&scidProp, v18),
                  ComponentTracker::ComponentIsOwned(v11, (IDClass<_tagDataID,32,0>)v12->id)) )
            {
              v17 = 0;
              ((void (__thiscall *)(UIElement *))v7->vfptr[2].__vecDelDtor)(v7);
            }
            else
            {
              v17 = 1;
            ...
            if ( (_DWORD)scidProp.m_pcPropertyDesc )
            {
              v13 = scidProp.m_pcPropertyDesc;
              v14 = scidProp.m_pcPropertyDesc->m_cRef - 1;
              scidProp.m_pcPropertyDesc->m_cRef = v14;
              if ( !v14 )
            ...
            {
              v15 = scidProp.m_pcPropertyValue;
              v16 = scidProp.m_pcPropertyValue->m_cRef - 1;
              scidProp.m_pcPropertyValue->m_cRef = v16;
              if ( !v16 )
        ...
        v3 = *(UIElement_ListBox **)(v18 + 144);
        ++v4;
      }
      while ( (signed int)v4 < (signed int)v3->m_listItems.m_num );
    }
  }
}
// 4ABE20: could not find valid save-restore pair for edi

//----- (004ABF60) --------------------------------------------------------  // acclient.c:227197
void __stdcall SpellExamineUI::GetComponentObjectID(unsigned int scid)
{
  ...
  SpellComponentTable::SCIDtoWCID((IDClass<_tagDataID,32,0> *)&scid, scid);
  ...
  if ( v3 )
  {
    ...
    do
    {
      ...
      if ( *(_DWORD *)v6 )
      {
        while ( scid != *(_DWORD *)(v7 + 8) )
        {
          v7 = *(_DWORD *)v7;
          if ( !v7 )
            goto LABEL_7;
        }
        ComponentData::GetFirstObjectID((ComponentData *)v7);
        return;
      }
LABEL_7:
      ++v4;
...
//----- (004ABFD0) --------------------------------------------------------  // acclient.c:227239
BOOL __thiscall AC1Legacy::PStringBase<char>::eq(AC1Legacy::PStringBase<char> *this, AC1Legacy::PStringBase<char> *rhs, int case_sensitive)
{
  return AC1Legacy::PStringBase<char>::cmp(this, rhs, case_sensitive) == 0;
}

//----- (004ABFF0) --------------------------------------------------------  // acclient.c:227245
AC1Legacy::PStringBase<char> *__cdecl AC1Legacy::operator+(AC1Legacy::PStringBase<char> *result, const char *lhs, AC1Legacy::PStringBase<char> *rhs)
{
  AC1Legacy::PStringBase<char> *v3; // edi@1
  AC1Legacy::PStringBase<char> *v4; // ST08_4@1
  AC1Legacy::PStringBase<char> *v5; // ST04_4@1
  AC1Legacy::PStringBase<char> *v6; // eax@1
  AC1Legacy::PStringBase<char> *v7; // esi@1

  v3 = result;
  v4 = rhs;
  v5 = result;
  AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&result, lhs);
  AC1Legacy::PStringBase<char>::operator+(v6, v5, v4);
  v7 = result;
  if ( !InterlockedDecrement((volatile LONG *)&result[1]) && v7 )
    ((void (__thiscall *)(AC1Legacy::PStringBase<char> *, signed int))v7->m_buffer->vfptr)(v7, 1);
  return v3;
}

//----- (004AC040) --------------------------------------------------------  // acclient.c:227265
void __userpurge gmExaminationUI::RecvNotice_UpdateSpellComponents(gmExaminationUI *this@<ecx>, signed int a2@<edi>, int i_change)
{
  SpellExamineUI *v3; // ecx@1

  v3 = (SpellExamineUI *)this->m_hashElementsRegisteredWith.m_intrusiveTable.m_aInplaceBuckets[2];
  if ( v3 )
    SpellExamineUI::UpdateComponents(v3, a2, (ComponentTrackerUpdate)i_change);
}

//----- (004AC050) --------------------------------------------------------  // acclient.c:227275
void __thiscall ItemExamineUI::AddItemInfo(ItemExamineUI *this, PStringBase<unsigned short> *ability_txt, int font, int surpressDoubleSpacing)
{
  ...
  if ( v5 )
  {
    ...
    UIElement_Text::AppendTextWithFont(v4->m_itemDisplayText, ability_txt, 0, font);
  }
}

//----- (004AC0E0) --------------------------------------------------------  // acclient.c:227308
void __thiscall ItemExamineUI::HandleInscriptionGainingFocus(ItemExamineUI *this)
{
  ItemExamineUI *v1; // edi@1
  AC1Legacy::PSRefBuffer<char> *v2; // ebp@1
  bool v3; // bl@1
  bool v4; // zf@4
  PSRefBufferCharData<unsigned short> *v5; // ebx@4
  unsigned int v6; // eax@6
  char *v7; // esi@6
  unsigned int v8; // eax@10
  PStringBase<unsigned short> *v9; // eax@12
  char *v10; // esi@12
  PStringBase<unsigned short> _text; // [sp+10h] [bp-8h]@1
  AC1Legacy::PStringBase<char> v12; // [sp+14h] [bp-4h]@1

  v1 = this;
  _text.m_charbuffer = (PSRefBufferCharData<unsigned short> *)this;
  AC1Legacy::PStringBase<char>::PStringBase<char>(&v12, &name);
  v2 = v12.m_buffer;
  v3 = strcmp(v1->m_scribe_name.m_buffer->m_data, v12.m_buffer->m_data) == 0;
  if ( !InterlockedDecrement((volatile LONG *)&v12.m_buffer->m_cRef) && v2 )
    v2->vfptr->__vecDelDtor((ReferenceCountTemplate<268435456,0> *)v2, 1u);
  v4 = v3 == 0;
  v5 = _text.m_charbuffer;
  if ( !v4 )
  {
    (*(void (__stdcall **)(signed int))(**(_DWORD **)&_text.m_charbuffer[4].m_data[2] + 156))(1);
    UIElement_Text::ClearAllText(*(UIElement_Text **)&_text.m_charbuffer[4].m_data[2]);
  }
  v6 = _wcslen(L"--");
  PStringBase<unsigned short>::allocate_ref_buffer(&_text, v6);
  _wcscpy(_text.m_charbuffer->m_data, L"--");
  UIElement_Text::SetText(*(UIElement_Text **)&v5[4].m_data[4], &_text);
  v7 = (char *)&_text.m_charbuffer[-1].m_data[6];
  if ( !InterlockedDecrement((volatile LONG *)&_text.m_charbuffer[-1].m_data[8]) && v7 )
    (**(void (__thiscall ***)(_DWORD, _DWORD))v7)(v7, 1);
  if ( SmartBox::smartbox )
    v8 = SmartBox::smartbox->player_id;
  else
    v8 = 0;
  v9 = (PStringBase<unsigned short> *)ACCWeenieObject::GetObjectNameWide(
                                        (ACCWeenieObject *)&v12,
                                        (PStringBase<unsigned short> *)v8,
                                        0,
                                        0);
  UIElement_Text::AppendText(*(UIElement_Text **)&v5[4].m_data[4], v9);
  v10 = (char *)&v12.m_buffer[-1].m_cRef;
  if ( !InterlockedDecrement((volatile LONG *)&v12.m_buffer[-1].m_cRef + 1) )
  {
    if ( v10 )
...
//----- (004AC230) --------------------------------------------------------  // acclient.c:227363
void __thiscall ItemExamineUI::HandleInscriptionMousePresses(ItemExamineUI *this)
{
  ItemExamineUI *v1; // ebx@1
  UIElement_Text *v2; // ecx@1
  int v3; // esi@5
  bool v4; // al@5
  PSRefBufferCharData<unsigned short> *v5; // ebp@5
  unsigned int v6; // eax@10
  char *v7; // eax@12
  AC1Legacy::PStringBase<char> *v8; // eax@12
  bool v9; // bl@12
  PSRefBufferCharData<unsigned short> *v10; // ebp@12
  HashBaseData<unsigned long> *v11; // eax@17
  ClientSystem *v12; // eax@20
  ClientSystem *v13; // eax@24
  char *v14; // esi@24
  BasePropertyDesc *v15; // ecx@28
  unsigned int v16; // edx@28
  BasePropertyValue *v17; // ecx@32
  unsigned int v18; // edx@32
  PStringBase<unsigned short> *v19; // [sp-Ch] [bp-30h]@19
  bool v20; // [sp-4h] [bp-28h]@19
  bool isEditable; // [sp+16h] [bp-Eh]@1
  bool v22; // [sp+17h] [bp-Dh]@5
  PStringBase<unsigned short> errorText; // [sp+18h] [bp-Ch]@5
  BaseProperty editProp; // [sp+1Ch] [bp-8h]@1

  v1 = this;
  v2 = this->m_itemInscriptionText;
  isEditable = 0;
  editProp.m_pcPropertyDesc = 0;
  editProp.m_pcPropertyValue = 0;
  if ( (unsigned __int8)((int (__stdcall *)(signed int, BaseProperty *))v2->vfptr[17].OnAction)(22, &editProp)
    && editProp.m_pcPropertyValue )
    ((void (__stdcall *)(bool *))editProp.m_pcPropertyValue->vfptr[28].__vecDelDtor)(&isEditable);
  if ( !isEditable )
  {
    AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&errorText, &name);
    v3 = (int)&v1->m_scribe_name;
    v4 = AC1Legacy::PStringBase<char>::operator!=(&v1->m_scribe_name, (AC1Legacy::PStringBase<char> *)&errorText);
    v5 = errorText.m_charbuffer;
    v22 = v4;
    if ( !InterlockedDecrement((volatile LONG *)&errorText.m_charbuffer->m_data[2]) && v5 )
      (**(void (__thiscall ***)(PSRefBufferCharData<unsigned short> *, signed int))&v5->m_data[0])(v5, 1);
    if ( v22 )
    {
      if ( SmartBox::smartbox )
        ...
        v6 = 0;
      v7 = ACCWeenieObject::GetObjectName((ACCWeenieObject *)v6, 0, 0);
      AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&errorText, v7);
      v9 = AC1Legacy::PStringBase<char>::operator!=(&v1->m_scribe_name, v8);
      v10 = errorText.m_charbuffer;
      if ( !InterlockedDecrement((volatile LONG *)&errorText.m_charbuffer->m_data[2]) && v10 )
        (**(void (__thiscall ***)(PSRefBufferCharData<unsigned short> *, signed int))&v10->m_data[0])(v10, 1);
      if ( v9 )
      {
        PStringBase<unsigned short>::PStringBase<unsigned short>(
          &errorText,
          0,
          L"Only %hs can change the inscription",
          *(_DWORD *)v3 + 20);
LABEL_24:
        v13 = (ClientSystem *)ClientUISystem::GetUISystem();
        ClientSystem::AddTextToScroll(v13, &errorText, 0x1Au, 1, 0);
        v14 = (char *)&errorText.m_charbuffer[-1].m_data[6];
        if ( !InterlockedDecrement((volatile LONG *)&errorText.m_charbuffer[-1].m_data[8]) && v14 )
    ...
    {
      v11 = ClientObjMaintSystem::GetWeenieObject(v1->cur_objid);
      if ( v11 )
      {
        if ( (unsigned int)v11[21].hash_next & 2 )
        {
          if ( v11[16].hash_next )
            goto LABEL_27;
          PStringBase<unsigned short>::PStringBase<unsigned short>(
            &errorText,
            L"Item must be in your inventory to inscribe.");
          v20 = 1;
          v19 = &errorText;
        }
        else
        {
          PStringBase<unsigned short>::PStringBase<unsigned short>(&errorText, L"This item is not inscribable.");
          v20 = 1;
          v19 = &errorText;
        }
        v12 = (ClientSystem *)ClientUISystem::GetUISystem();
        ClientSystem::AddTextToScroll(v12, v19, 0x1Au, v20, 0);
        PStringBase<char>::~PStringBase<char>((CaseInsensitiveStringBase<PStringBase<char> > *)&errorText);
        goto LABEL_27;
      }
    }
    PStringBase<unsigned short>::PStringBase<unsigned short>(&errorText, L"Item must be in your inventory to inscribe.");
    goto LABEL_24;
  }
LABEL_27:
  if ( (_DWORD)editProp.m_pcPropertyDesc )
  {
    v15 = editProp.m_pcPropertyDesc;
    v16 = editProp.m_pcPropertyDesc->m_cRef - 1;
    editProp.m_pcPropertyDesc->m_cRef = v16;
    if ( !v16 )
      ((void (__stdcall *)(signed int))v15->vfptr->__vecDelDtor)(1);
    editProp.m_pcPropertyDesc = 0;
  }
  if ( editProp.m_pcPropertyValue )
  {
    v17 = editProp.m_pcPropertyValue;
    v18 = editProp.m_pcPropertyValue->m_cRef - 1;
    editProp.m_pcPropertyValue->m_cRef = v18;
    if ( !v18 )
      ((void (__stdcall *)(signed int))v17->vfptr->__vecDelDtor)(1);
  }
}

//----- (004AC440) --------------------------------------------------------  // acclient.c:227486
PStringBase<char> *__cdecl operator+(PStringBase<char> *result, const char *lhs, PStringBase<char> *rhs)
{
  PStringBase<char> *v3; // edi@1
  PStringBase<char> *v4; // ST08_4@1
  PStringBase<char> *v5; // ST04_4@1
  PStringBase<char> *v6; // eax@1
  PStringBase<char> *v7; // esi@1

  v3 = result;
  v4 = rhs;
  v5 = result;
  PStringBase<char>::PStringBase<char>((PStringBase<char> *)&result, lhs);
  PStringBase<char>::operator+(v6, v5, v4);
  v7 = result - 5;
...
//----- (004AC490) --------------------------------------------------------  // acclient.c:227506
void __thiscall AC1Legacy::PStringBase<char>::append_int32(AC1Legacy::PStringBase<char> *this, int num)
{
  AC1Legacy::PStringBase<char> *v2; // edi@1
  AC1Legacy::PSRefBuffer<char> *v3; // esi@1
  AC1Legacy::PStringBase<char> buf; // [sp+0h] [bp-4h]@1

  buf.m_buffer = (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
  v2 = this;
  InterlockedIncrement((volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4));
  AC1Legacy::PStringBase<char>::sprintf(&buf, "%ld", num);
  v3 = buf.m_buffer;
  if ( buf.m_buffer != (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer )
    AC1Legacy::PStringBase<char>::append_n_chars(v2, buf.m_buffer->m_data, buf.m_buffer->m_len - 1);
...
//----- (004AC500) --------------------------------------------------------  // acclient.c:227528
char __thiscall AC1Legacy::PStringBase<char>::InsertCommas(AC1Legacy::PStringBase<char> *this)
{
  AC1Legacy::PSRefBuffer<char> *v1; // ecx@1
  ...
  int v7; // ebp@5
  int v8; // edi@10
  volatile LONG *v9; // ebx@10
  int v10; // ebx@13
  AC1Legacy::PSRefBuffer<char> *v11; // edi@13
  char *v12; // ecx@13
  ...
  int v17; // eax@22
  char v18; // cl@23
  AC1Legacy::PSRefBuffer<char> *v19; // eax@26
  ...
  int v25; // eax@34
  char v26; // cl@35
  AC1Legacy::PStringBase<char> *v27; // ebx@38
  AC1Legacy::PSRefBuffer<char> *v28; // esi@38
  char str[4]; // [sp+4h] [bp-18h]@17
  AC1Legacy::PStringBase<char> outString; // [sp+8h] [bp-14h]@10
  int commas; // [sp+Ch] [bp-10h]@13
  int extra; // [sp+10h] [bp-Ch]@8
  int amt; // [sp+14h] [bp-8h]@13
  AC1Legacy::PStringBase<char> *v34; // [sp+18h] [bp-4h]@1
  ...
  else
  {
    ...
    if ( v7 <= 0 )
      ...
      extra = (v7 - 1) / 3;
    v8 = AC1Legacy::PStringBase<char>::s_NullBuffer;
    v9 = (volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4);
    outString.m_buffer = (AC1Legacy::PSRefBuffer<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
    InterlockedIncrement((volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4));
    if ( !InterlockedDecrement(v9) && v8 )
      (**(void (__thiscall ***)(_DWORD, _DWORD))v8)(v8, 1);
    v10 = extra;
    AC1Legacy::PStringBase<char>::allocate_ref_buffer(&outString, extra + v3);
    v11 = outString.m_buffer;
    v12 = (char *)outString.m_buffer + v10;
    v13 = 0;
    v14 = v3 - 1;
    v12[v3 + 20] = 0;
    commas = 0;
    for ( amt = 0; v14 >= 0; ++amt )
    {
      if ( v13 > 0 && v7 > 0 && !(v13 % 3) )
      {
        str[0] = 44;
        v15 = v11->m_len;
        v16 = extra + v14 - commas;
        if ( v16 < v15 && v11->m_data[v16] != 44 )
        {
          if ( v16 == v15 - 1 )
          {
            AC1Legacy::PStringBase<char>::append_n_chars(&outString, str, 1u);
            v11 = outString.m_buffer;
          }
          else
          {
            AC1Legacy::PStringBase<char>::break_reference(&outString);
            v11 = outString.m_buffer;
            outString.m_buffer->m_data[v16] = str[0];
            if ( !str[0] )
            {
              v17 = (int)v11->m_data;
              do
                v18 = *(_BYTE *)v17++;
              while ( v18 );
              v11->m_len = v17 - (_DWORD)((char *)v11 + 21) + 1;
            }
          }
        }
        ++commas;
      ...
      v19 = v34->m_buffer;
      v20 = v34->m_buffer->m_len;
      if ( v14 < v20 )
        v21 = (int)&v19->m_data[v14];
      else
        v21 = (int)((char *)&v19->m_hash + v20 + 3);
      v22 = *(_BYTE *)v21;
      v23 = extra + v14 - commas;
      str[0] = *(_BYTE *)v21;
      v24 = v11->m_len;
      if ( v23 < v24 && v11->m_data[v23] != v22 )
      {
        if ( v23 == v24 - 1 )
        {
          AC1Legacy::PStringBase<char>::append_n_chars(&outString, str, 1u);
        ...
        else
        {
          AC1Legacy::PStringBase<char>::break_reference(&outString);
          v11 = outString.m_buffer;
          outString.m_buffer->m_data[v23] = str[0];
          if ( !str[0] )
          {
            v25 = (int)v11->m_data;
            do
              v26 = *(_BYTE *)v25++;
            while ( v26 );
            v11->m_len = v25 - (_DWORD)((char *)v11 + 21) + 1;
          }
        }
      }
      v13 = amt + 1;
    ...
    if ( v34->m_buffer != v11 )
    {
      if ( !InterlockedDecrement((volatile LONG *)&v28->m_cRef) && v28 )
...
//----- (004AC720) --------------------------------------------------------  // acclient.c:227688
void __thiscall ItemExamineUI::SetInscriptionEditableState(ItemExamineUI *this)
{
  ItemExamineUI *v1; // esi@1
  ...
  int v8; // eax@11
  int v9; // eax@11
  AC1Legacy::PSRefBuffer<char> *v10; // edi@11
  bool v11; // bl@11
  bool v12; // zf@14
  PlayerDesc *v13; // edi@16
  BasePropertyDesc *v14; // ecx@39
  unsigned int v15; // edx@39
  BasePropertyValue *v16; // ecx@43
  unsigned int v17; // edx@43
  BasePropertyDesc *v18; // ecx@47
  unsigned int v19; // edx@47
  BasePropertyValue *v20; // ecx@51
  unsigned int v21; // edx@51
  int v22; // [sp-8h] [bp-40h]@3
  char v23; // [sp+Fh] [bp-29h]@19
  Interface *_rpInterface; // [sp+10h] [bp-28h]@3
  AC1Legacy::PStringBase<char> v25; // [sp+14h] [bp-24h]@5
  ACCWeenieObject *weenObj; // [sp+18h] [bp-20h]@1
  TResult result; // [sp+1Ch] [bp-1Ch]@3
  BaseProperty selectProp; // [sp+20h] [bp-18h]@1
  BaseProperty editProp; // [sp+28h] [bp-10h]@1
  InterfacePtr<PlayerDesc> spPD; // [sp+30h] [bp-8h]@3

  v1 = this;
  editProp.m_pcPropertyDesc = 0;
  editProp.m_pcPropertyValue = 0;
  BaseProperty::SetPropertyName(&editProp, 0x16u);
  selectProp.m_pcPropertyDesc = 0;
  selectProp.m_pcPropertyValue = 0;
  BaseProperty::SetPropertyName(&selectProp, 0x27u);
  v2 = ClientObjMaintSystem::GetWeenieObject(v1->cur_objid);
  weenObj = (ACCWeenieObject *)v2;
  if ( v2 && (unsigned int)v2[21].hash_next & 2 )
  {
    _rpInterface = 0;
    v3 = InterfaceSystem::GetInstance();
    InterfaceSystem::GetClass(v3, &result, &PlayerDesc_ClassType_7, &_rpInterface);
    v4 = _rpInterface;
    v22 = (int)_rpInterface;
    spPD.m_pInterface = 0;
    spPD.m_trStatus.m_val = 0;
    if ( _rpInterface )
      _rpInterface->vfptr->AddRef(_rpInterface);
    result.m_val = *(_DWORD *)InterfacePtr<PlayerDesc>::_QueryInterface(&spPD, (int)&v25, v22, 0);
    if ( v4 )
      v4->vfptr->Release(v4);
    AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&_rpInterface, &name);
    v5 = _rpInterface;
    if ( __stricmp(v1->m_scribe_name.m_buffer->m_data, (const char *)&_rpInterface[5]) )
    {
      if ( SmartBox::smartbox )
        v6 = SmartBox::smartbox->player_id;
      else
        v6 = 0;
      v7 = ACCWeenieObject::GetObjectName((ACCWeenieObject *)v6, 0, 0);
      AC1Legacy::PStringBase<char>::PStringBase<char>(&v25, v7);
      v9 = __stricmp(v1->m_scribe_name.m_buffer->m_data, (const char *)(*(_DWORD *)v8 + 20));
      v10 = v25.m_buffer;
      v11 = v9 == 0;
      if ( !InterlockedDecrement((volatile LONG *)&v25.m_buffer->m_cRef) && v10 )
    ...
    if ( ACCWeenieObject::IsOwnedByPlayer(weenObj) )
    {
      v13 = spPD.m_pInterface;
    }
    else
    {
LABEL_61:
      v13 = spPD.m_pInterface;
      if ( !(_DWORD)spPD.m_pInterface || (result.m_val & 0x80000000) != 0 || !PlayerDesc::PlayerIsPSR(spPD.m_pInterface) )
      {
        v23 = 0;
        goto LABEL_22;
      }
...
LABEL_22:
    if ( !InterlockedDecrement((volatile LONG *)&v5[1]) && v5 )
      ((void (__thiscall *)(Interface *, signed int))v5->vfptr->IUnknown_QueryInterface)(v5, 1);
    if ( v23 )
    {
      if ( editProp.m_pcPropertyValue )
      {
        BaseProperty::CheckCopyOnWrite(&editProp);
        ((void (__stdcall *)(signed int))editProp.m_pcPropertyValue->vfptr[29].__vecDelDtor)(1);
      }
      ((void (__stdcall *)(BaseProperty *))v1->m_itemInscriptionText->vfptr[17].OnLoseFocus)(&editProp);
      if ( selectProp.m_pcPropertyValue )
      {
        BaseProperty::CheckCopyOnWrite(&selectProp);
        ((void (__stdcall *)(signed int))selectProp.m_pcPropertyValue->vfptr[29].__vecDelDtor)(1);
      }
      ((void (__stdcall *)(BaseProperty *))v1->m_itemInscriptionText->vfptr[17].OnLoseFocus)(&selectProp);
      ((void (__thiscall *)(UIElement *, _DWORD))v1->m_itemInscriptionBackground->vfptr[22].OnLoseFocus)(
        v1->m_itemInscriptionBackground,
        0);
    }
    else
    {
      ...
      {
        BaseProperty::CheckCopyOnWrite(&editProp);
        ((void (__stdcall *)(_DWORD))editProp.m_pcPropertyValue->vfptr[29].__vecDelDtor)(0);
      }
      ((void (__stdcall *)(BaseProperty *))v1->m_itemInscriptionText->vfptr[17].OnLoseFocus)(&editProp);
      if ( selectProp.m_pcPropertyValue )
      {
        BaseProperty::CheckCopyOnWrite(&selectProp);
        ((void (__stdcall *)(_DWORD))selectProp.m_pcPropertyValue->vfptr[29].__vecDelDtor)(0);
      }
      ((void (__stdcall *)(_DWORD))v1->m_itemInscriptionText->vfptr[17].OnLoseFocus)(&selectProp);
      ((void (__thiscall *)(UIElement *, signed int))v1->m_itemInscriptionBackground->vfptr[22].OnLoseFocus)(
        v1->m_itemInscriptionBackground,
        1);
    }
    if ( v13 )
  ...
  ((void (__stdcall *)(_DWORD))v1->m_itemInscriptionText->vfptr[17].OnLoseFocus)(&editProp);
  if ( selectProp.m_pcPropertyValue )
  {
    BaseProperty::CheckCopyOnWrite(&selectProp);
    ((void (__stdcall *)(_DWORD))selectProp.m_pcPropertyValue->vfptr[29].__vecDelDtor)(0);
  ...
  ((void (__thiscall *)(UIElement *, signed int))v1->m_itemInscriptionBackground->vfptr[22].OnLoseFocus)(
    ...
    1);
LABEL_38:
  if ( (_DWORD)selectProp.m_pcPropertyDesc )
  {
    v14 = selectProp.m_pcPropertyDesc;
    v15 = selectProp.m_pcPropertyDesc->m_cRef - 1;
    selectProp.m_pcPropertyDesc->m_cRef = v15;
    if ( !v15 )
  ...
  if ( selectProp.m_pcPropertyValue )
  {
    v16 = selectProp.m_pcPropertyValue;
    v17 = selectProp.m_pcPropertyValue->m_cRef - 1;
    selectProp.m_pcPropertyValue->m_cRef = v17;
    if ( !v17 )
  ...
  if ( (_DWORD)editProp.m_pcPropertyDesc )
  {
    v18 = editProp.m_pcPropertyDesc;
    v19 = editProp.m_pcPropertyDesc->m_cRef - 1;
    editProp.m_pcPropertyDesc->m_cRef = v19;
    if ( !v19 )
  ...
  if ( editProp.m_pcPropertyValue )
  {
    v20 = editProp.m_pcPropertyValue;
    v21 = editProp.m_pcPropertyValue->m_cRef - 1;
    editProp.m_pcPropertyValue->m_cRef = v21;
    if ( !v21 )
      ((void (__stdcall *)(signed int))v20->vfptr->__vecDelDtor)(1);
  }
}

//----- (004ACAC0) --------------------------------------------------------  // acclient.c:227876
void __stdcall ItemExamineUI::GetAppraisalStringFromRequirements(unsigned int iReq, int iSkill, int iDiff, AC1Legacy::PStringBase<char> *strSkill)
{
  AC1Legacy::PStringBase<char> *v5; // esi@6
  AC1Legacy::PStringBase<char> *v6; // esi@7
  const char *v7; // [sp-4h] [bp-Ch]@4

  if ( iReq == 2 || iReq == 4 || iReq == 6 )
    v7 = "base ";
  else
    v7 = &name;
  v5 = strSkill;
  AC1Legacy::PStringBase<char>::set(strSkill, v7);
  switch ( iReq )
  {
    case 1u:
    case 2u:
    case 8u:
      strSkill = (AC1Legacy::PStringBase<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
      InterlockedIncrement((volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4));
      SkillSystem::InqSkillName(iSkill, (AC1Legacy::PStringBase<char> *)&strSkill);
      AC1Legacy::PStringBase<char>::operator+=(v5, (AC1Legacy::PStringBase<char> *)&strSkill);
      v6 = strSkill;
      if ( !InterlockedDecrement((volatile LONG *)&strSkill[1]) )
      {
        if ( v6 )
    ...
    case 4u:
      strSkill = (AC1Legacy::PStringBase<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
      InterlockedIncrement((volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4));
      SkillSystem::InqAttributeName(iSkill, (AC1Legacy::PStringBase<char> *)&strSkill);
      goto LABEL_12;
    case 5u:
    case 6u:
      strSkill = (AC1Legacy::PStringBase<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer;
      InterlockedIncrement((volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4));
      SkillSystem::InqAttribute2ndName(iSkill, (AC1Legacy::PStringBase<char> *)&strSkill);
LABEL_12:
      AC1Legacy::PStringBase<char>::operator+=(v5, (AC1Legacy::PStringBase<char> *)&strSkill);
    ...
    case 9u:
    case 0xAu:
      AC1Legacy::PStringBase<char>::set(v5, "unknown quality");
      switch ( iSkill )
      {
        case 287:
          AC1Legacy::PStringBase<char>::set(v5, "Standing with the Celestial Hand");
          break;
        case 288:
          AC1Legacy::PStringBase<char>::set(v5, "Standing with the Eldrytch Web");
          break;
        case 289:
          AC1Legacy::PStringBase<char>::set(v5, "Standing with the Radiant Blood");
          break;
        default:
          AC1Legacy::PStringBase<char>::set(v5, "unknown quality");
          break;
      ...
      break;
    case 7u:
      AC1Legacy::PStringBase<char>::set(v5, "level");
      break;
    case 0xBu:
      AppraisalSystem::InqCreatureDisplayName(iDiff, v5);
      break;
    case 0xCu:
      AppraisalSystem::InqHeritageGroupDisplayName(iDiff, v5);
      break;
    default:
      return;
  }
...
//----- (004ACC90) --------------------------------------------------------  // acclient.c:227954
void __cdecl AppendHelper(AC1Legacy::PStringBase<char> *string, const char *szAppend)
{
  AC1Legacy::PStringBase<char> *v2; // edi@1
  AC1Legacy::PStringBase<char> *v3; // esi@2
  AC1Legacy::PSRefBuffer<char> *v4; // eax@2
  AC1Legacy::PStringBase<char> *v5; // esi@7
  AC1Legacy::PSRefBuffer<char> *v6; // eax@7

  v2 = string;
  if ( string->m_buffer->m_len != 1 )
  {
    AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&string, ", ");
    v3 = string;
    v4 = string[2].m_buffer;
    if ( v4 != (AC1Legacy::PSRefBuffer<char> *)1
      && string != (AC1Legacy::PStringBase<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer )
      AC1Legacy::PStringBase<char>::append_n_chars(v2, (const char *)&string[5], (unsigned int)&v4[-1].m_data[3]);
    if ( !InterlockedDecrement((volatile LONG *)&v3[1]) )
      ((void (__thiscall *)(_DWORD, _DWORD))v3->m_buffer->vfptr)(v3, 1);
  }
  AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&string, szAppend);
  v5 = string;
  v6 = string[2].m_buffer;
  if ( v6 != (AC1Legacy::PSRefBuffer<char> *)1
    && string != (AC1Legacy::PStringBase<char> *)AC1Legacy::PStringBase<char>::s_NullBuffer )
    AC1Legacy::PStringBase<char>::append_n_chars(v2, (const char *)&string[5], (unsigned int)&v6[-1].m_data[3]);
  if ( !InterlockedDecrement((volatile LONG *)&v5[1]) )
    ((void (__thiscall *)(_DWORD, _DWORD))v5->m_buffer->vfptr)(v5, 1);
}
// 8EE10C: using guessed type int AC1Legacy::PStringBase<char>::s_NullBuffer;

//----- (004ACD30) --------------------------------------------------------  // acclient.c:227986
void __thiscall BasicCreatureExamineUI::BasicCreatureExamineUI(BasicCreatureExamineUI *this, gmExaminationUI *_parentElement)
{
  BasicCreatureExamineUI *v2; // ebx@1
  UIElement *v3; // ecx@1
  bool v4; // zf@1
  UIElement *v5; // ecx@3
  UIElement *v6; // eax@4
  ...
  UIElement *v15; // eax@7
  int v16; // eax@8
  UIElement *v17; // ecx@10
  UIElement *v18; // eax@10
  int v19; // esi@11
  AttributeInfoRegion *v20; // eax@14
  gmExaminationUI *v21; // eax@15
  AttributeInfoRegion *v22; // eax@17
  gmExaminationUI *v23; // eax@18
  AttributeInfoRegion *v24; // eax@20
  gmExaminationUI *v25; // eax@21
  AttributeInfoRegion *v26; // eax@23
  gmExaminationUI *v27; // eax@24
  AttributeInfoRegion *v28; // eax@26
  gmExaminationUI *v29; // eax@27
  AttributeInfoRegion *v30; // eax@29
  gmExaminationUI *v31; // eax@30
  Attribute2ndInfoRegion *v32; // eax@32
  gmExaminationUI *v33; // eax@33
  Attribute2ndInfoRegion *v34; // eax@35
  gmExaminationUI *v35; // eax@36
  Attribute2ndInfoRegion *v36; // eax@38
  gmExaminationUI *v37; // eax@39
  AttributeInfoRegion *v38; // eax@43
  gmExaminationUI *v39; // eax@44
  AttributeInfoRegion *v40; // eax@46
  gmExaminationUI *v41; // eax@47
  AttributeInfoRegion *v42; // eax@49
  gmExaminationUI *v43; // eax@50
  AttributeInfoRegion *v44; // eax@52
  gmExaminationUI *v45; // eax@53
  AttributeInfoRegion *v46; // eax@55
  gmExaminationUI *v47; // eax@56
  AttributeInfoRegion *v48; // eax@58
  gmExaminationUI *v49; // eax@59
  Attribute2ndInfoRegion *v50; // eax@61
  gmExaminationUI *v51; // eax@62
  Attribute2ndInfoRegion *v52; // eax@64
  gmExaminationUI *v53; // eax@65
  Attribute2ndInfoRegion *v54; // eax@67
  gmExaminationUI *v55; // eax@68
  ...
  this->cur_weenobj = 0;
  AppraisalProfile::AppraisalProfile(&this->cur_prof);
  v3 = (UIElement *)_parentElement;
  v4 = _parentElement == 0;
  v2->m_pParentElement = _parentElement;
  v2->vfptr = (ExamineSubUIVtbl *)&BasicCreatureExamineUI::vftable;
  v2->m_basicCreatureExamineBaseField = 0;
  v2->m_levelValueText = 0;
  v2->m_pPaperDoll = 0;
  v2->m_p3DObj = 0;
  v2->m_extraInfoList = 0;
  if ( !v4 )
    v2->m_basicCreatureExamineBaseField = UIElement::GetChildRecursive(v3, 0x10000140u);
  v5 = v2->m_basicCreatureExamineBaseField;
  if ( v5 )
  {
    v6 = UIElement::GetChildRecursive(v5, 0x1000014Cu);
    v7 = v2->m_basicCreatureExamineBaseField;
    v2->m_levelValueText = (UIElement_Text *)v6;
    v8 = UIElement::GetChildRecursive(v7, 0x1000014Du);
    v9 = v2->m_basicCreatureExamineBaseField;
    v2->m_creatureInfoSubPanel = v8;
    v10 = UIElement::GetChildRecursive(v9, 0x1000014Fu);
    v11 = (UIElement *)&v2->m_pParentElement->vfptr;
    v2->m_characterInfoSubPanel = v10;
    v12 = UIElement::GetChildRecursive(v11, 0x10000148u);
    if ( v12 )
      v13 = v12->vfptr[12].OnAction((IInputActionCallback *)v12, (InputEvent *)13);
    else
      v13 = 0;
    v14 = v2->m_basicCreatureExamineBaseField;
    v2->m_pPaperDoll = (UIElement_Viewport *)v13;
    v15 = UIElement::GetChildRecursive(v14, 0x10000335u);
    if ( v15 )
      v16 = v15->vfptr[12].OnAction((IInputActionCallback *)v15, (InputEvent *)5);
    else
      v16 = 0;
    v17 = v2->m_basicCreatureExamineBaseField;
    v2->m_extraInfoList = (UIElement_ListBox *)v16;
    v18 = UIElement::GetChildRecursive(v17, 0x10000149u);
    if ( v18 )
      v19 = v18->vfptr[12].OnAction((IInputActionCallback *)v18, (InputEvent *)5);
    else
      v19 = 0;
    if ( !BasicCreatureExamineUI::m_rgTokens.m_num )
    {
      v20 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v20 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v20,
          (UIElement_ListBox *)v19,
          BasicCreatureExamineUI::m_rgTokens.m_num,
          1u,
          i_iconID,
          0);
        _parentElement = v21;
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v22 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v22 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v22,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v24 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v24 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v24,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v26 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v26 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v26,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v28 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v28 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v28,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v30 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v30 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v30,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v32 = (Attribute2ndInfoRegion *)operator new(0x20u);
      if ( v32 )
      {
        Attribute2ndInfoRegion::Attribute2ndInfoRegion(
          v32,
          (UIElement_ListBox *)v19,
          BasicCreatureExamineUI::m_rgTokens.m_num,
          2u,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v34 = (Attribute2ndInfoRegion *)operator new(0x20u);
      if ( v34 )
      {
        Attribute2ndInfoRegion::Attribute2ndInfoRegion(
          v34,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v36 = (Attribute2ndInfoRegion *)operator new(0x20u);
      if ( v36 )
      {
        Attribute2ndInfoRegion::Attribute2ndInfoRegion(
          v36,
    ...
    if ( !*(_DWORD *)(v19 + 1552) )
    {
      v38 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v38 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v38,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v40 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v40 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v40,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v42 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v42 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v42,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v44 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v44 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v44,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v46 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v46 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v46,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v48 = (AttributeInfoRegion *)operator new(0x18u);
      if ( v48 )
      {
        AttributeInfoRegion::AttributeInfoRegion(
          v48,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v50 = (Attribute2ndInfoRegion *)operator new(0x20u);
      if ( v50 )
      {
        Attribute2ndInfoRegion::Attribute2ndInfoRegion(
          v50,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v52 = (Attribute2ndInfoRegion *)operator new(0x20u);
      if ( v52 )
      {
        Attribute2ndInfoRegion::Attribute2ndInfoRegion(
          v52,
      ...
      SmartArray<UIElement_Button *,1>::AddToEnd(&BasicCreatureExamineUI::m_rgTokens, (BSPNODE *const *)&_parentElement);
      v54 = (Attribute2ndInfoRegion *)operator new(0x20u);
      if ( v54 )
      {
        Attribute2ndInfoRegion::Attribute2ndInfoRegion(
          v54,
...
// 7AF2F0: using guessed type void (__thiscall *ExamineSubUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);
// 7AF4C4: using guessed type void (__thiscall *BasicCreatureExamineUI::vftable)(BasicCreatureExamineUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);

//----- (004AD2E0) --------------------------------------------------------  // acclient.c:228414
void __thiscall BasicCreatureExamineUI::~BasicCreatureExamineUI(BasicCreatureExamineUI *this)
{
  ...
  UIElement_Viewport *v6; // eax@9
  CPhysicsObj *v7; // ecx@11
  BasicCreatureExamineUI *v8; // [sp+8h] [bp-4h]@1

  v8 = this;
  this->vfptr = (ExamineSubUIVtbl *)&BasicCreatureExamineUI::vftable;
  v1 = this->m_extraInfoList;
  if ( v1 )
    UIElement_ListBox::Flush(v1);
  v2 = BasicCreatureExamineUI::m_rgTokens.m_num;
  v3 = 0;
  if ( BasicCreatureExamineUI::m_rgTokens.m_num )
  {
    do
    {
      v4 = BasicCreatureExamineUI::m_rgTokens.m_data[v3];
      if ( v4 )
        ((void (__stdcall *)(signed int))v4->vfptr->sphere_intersects_solid)(1);
      BasicCreatureExamineUI::m_rgTokens.m_data[v3] = 0;
      v2 = BasicCreatureExamineUI::m_rgTokens.m_num;
      ++v3;
    }
    while ( v3 < BasicCreatureExamineUI::m_rgTokens.m_num );
  }
  v5 = 0;
  if ( v2 )
  {
    do
      BasicCreatureExamineUI::m_rgTokens.m_data[v5++] = 0;
    while ( v5 < BasicCreatureExamineUI::m_rgTokens.m_num );
  }
  BasicCreatureExamineUI::m_rgTokens.m_num = 0;
  v6 = v8->m_pPaperDoll;
  if ( v6 )
    CreatureMode::RemoveAllObjects((CreatureMode *)&v6->creature_mode_objects);
  v7 = v8->m_p3DObj;
  if ( v7 )
    ((void (__stdcall *)(_DWORD))v7->vfptr->__vecDelDtor)(1);
  v8->m_p3DObj = 0;
  v8->vfptr = (ExamineSubUIVtbl *)&ExamineSubUI::vftable;
  AppraisalProfile::~AppraisalProfile(&v8->cur_prof);
}
// 7AF2F0: using guessed type void (__thiscall *ExamineSubUI::vftable)(ExamineSubUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);
// 7AF4C4: using guessed type void (__thiscall *BasicCreatureExamineUI::vftable)(BasicCreatureExamineUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);

//----- (004AD3C0) --------------------------------------------------------  // acclient.c:228467
void __thiscall CharExamineUI::CharExamineUI(CharExamineUI *this, gmExaminationUI *_parentElement)
{
  CharExamineUI *v2; // esi@1
  UIElement *v3; // ecx@1
  UIElement *v4; // eax@2
  ...
  v2 = this;
  BasicCreatureExamineUI::BasicCreatureExamineUI((BasicCreatureExamineUI *)&this->vfptr, _parentElement);
  v3 = v2->m_basicCreatureExamineBaseField;
  v2->vfptr = (ExamineSubUIVtbl *)&CharExamineUI::vftable;
  v2->m_displayText_Heritage = 0;
  v2->m_displayText_Profession = 0;
  v2->m_displayText_PlayerKiller = 0;
  v2->m_displayText_AllegianceName = 0;
  if ( v3 )
  {
    v4 = UIElement::GetChildRecursive(v3, 0x10000150u);
    v5 = v2->m_basicCreatureExamineBaseField;
    v2->m_displayText_Heritage = (UIElement_Text *)v4;
    v6 = UIElement::GetChildRecursive(v5, 0x10000151u);
    v7 = v2->m_basicCreatureExamineBaseField;
    v2->m_displayText_Profession = (UIElement_Text *)v6;
    v8 = UIElement::GetChildRecursive(v7, 0x10000152u);
    v9 = v2->m_basicCreatureExamineBaseField;
    v2->m_displayText_PlayerKiller = (UIElement_Text *)v8;
    v2->m_displayText_AllegianceName = (UIElement_Text *)UIElement::GetChildRecursive(v9, 0x1000053Au);
  }
}
// 7AF4DC: using guessed type void (__thiscall *CharExamineUI::vftable)(BasicCreatureExamineUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);

//----- (004AD450) --------------------------------------------------------  // acclient.c:228503
double __stdcall SpellExamineUI::DetermineSpellRange(CSpellBase *_spellBase)
{
  ...
  int skillLevel; // [sp+Ch] [bp-18h]@5
  int life; // [sp+10h] [bp-14h]@1
  int v17; // [sp+14h] [bp-10h]@1
  int itemEnch; // [sp+18h] [bp-Ch]@3
  int creatureEnch; // [sp+1Ch] [bp-8h]@1
  int _void; // [sp+20h] [bp-4h]@1

  _void = 0;
  v2 = InterfaceSystem::GetInstance();
  InterfaceSystem::GetClass(v2, (TResult *)&creatureEnch, &PlayerDesc_ClassType_7, (Interface **)&_void);
  v14 = _void;
  v3 = _void;
  life = 0;
  v17 = 0;
  if ( _void )
    (*(void (__thiscall **)(int))(*(_DWORD *)_void + 16))(_void);
  InterfacePtr<PlayerDesc>::_QueryInterface(&life, (int)&itemEnch, v14, 0);
  if ( v3 )
    (*(void (__thiscall **)(int))(*(_DWORD *)v3 + 20))(v3);
  v4 = _spellBase;
  skillLevel = 0;
  if ( CSpellBase::InqSkillForSpell(_spellBase) )
  {
    v11 = CSpellBase::InqSkillForSpell(v4);
    v5 = life;
    CACQualities::InqSkillLevel((CACQualities *)life, v11, &skillLevel);
  }
  else
  {
    v5 = life;
    creatureEnch = 0;
    CACQualities::InqSkillLevel((CACQualities *)life, 0x1Fu, &creatureEnch);
    itemEnch = 0;
    CACQualities::InqSkillLevel((CACQualities *)v5, 0x20u, &itemEnch);
    life = 0;
    CACQualities::InqSkillLevel((CACQualities *)v5, 0x21u, &life);
    *(float *)&_spellBase = 0.0;
    CACQualities::InqSkillLevel((CACQualities *)v5, 0x22u, (int *)&_spellBase);
    _void = 0;
    CACQualities::InqSkillLevel((CACQualities *)v5, 0x2Bu, &_void);
    v6 = &_spellBase;
    if ( life >= (signed int)_spellBase )
      v6 = &life;
    if ( itemEnch >= *(_DWORD *)v6 )
      v6 = &itemEnch;
    if ( creatureEnch >= *(_DWORD *)v6 )
      v6 = &creatureEnch;
    v7 = *(_DWORD *)v6;
    skillLevel = v7;
    v9 = __OFSUB__(_void, v7);
    v8 = _void - v7 < 0;
    v10 = &skillLevel;
    if ( !(v8 ^ v9) )
      v10 = &_void;
  ...
  *(float *)&_spellBase = v12;
  if ( v12 > 75.0 )
    *(float *)&_spellBase = RADAR_OUTDOOR_RADIUS;
  if ( v5 )
    (*(void (__thiscall **)(int))(*(_DWORD *)v5 + 20))(v5);
  return *(float *)&_spellBase;
}

//----- (004AD5D0) --------------------------------------------------------  // acclient.c:228583
char __thiscall AC1Legacy::PStringBase<char>::convert(AC1Legacy::PStringBase<char> *this, int i_int32, int comma)
{
  AC1Legacy::PStringBase<char> *v3; // edi@1
  AC1Legacy::PSRefBuffer<char> *v4; // esi@1
  volatile LONG *v5; // ST00_4@5
  char result; // al@7
  ...
  AC1Legacy::PStringBase<char>::append_int32(v3, i_int32);
  if ( comma )
    result = AC1Legacy::PStringBase<char>::InsertCommas(v3);
  else
    result = 1;
  return result;
}
...
//----- (004AD640) --------------------------------------------------------  // acclient.c:228610
AC1Legacy::PStringBase<char> *__thiscall AC1Legacy::PStringBase<char>::operator=(AC1Legacy::PStringBase<char> *this, int i_int32)
{
  AC1Legacy::PStringBase<char> *v2; // edi@1
  AC1Legacy::PSRefBuffer<char> *v3; // esi@1
  ...
  AC1Legacy::PStringBase<char>::append_int32(v2, i_int32);
  AC1Legacy::PStringBase<char>::InsertCommas(v2);
  return v2;
}
// 8EE10C: using guessed type int AC1Legacy::PStringBase<char>::s_NullBuffer;

//----- (004AD6A0) --------------------------------------------------------  // acclient.c:228633
void __thiscall gmExaminationUI::PostInit(gmExaminationUI *this)
{
  gmExaminationUI *v1; // esi@1
  UIElement *v2; // eax@1
  int v3; // eax@2
  ItemExamineUI *v4; // eax@4
  ItemExamineUI *v5; // eax@5
  BasicCreatureExamineUI *v6; // eax@7
  BasicCreatureExamineUI *v7; // edi@7
  UIElement *v8; // ecx@8
  CharExamineUI *v9; // eax@11
  CharExamineUI *v10; // eax@12
  SpellExamineUI *v11; // eax@14
  SpellExamineUI *v12; // eax@15
  GlobalEventHandler *v13; // eax@17
  GlobalEventHandler *v14; // edi@17

  v1 = this;
  UIElement::PostInit((UIElement *)&this->vfptr);
  v2 = UIElement::GetChildRecursive((UIElement *)&v1->vfptr, 0x1000012Du);
  if ( v2 )
    v3 = v2->vfptr[12].OnAction((IInputActionCallback *)v2, (InputEvent *)12);
  else
    v3 = 0;
  v1->m_displayedNameText = (UIElement_Text *)v3;
  v4 = (ItemExamineUI *)operator new(0xA8u);
  if ( v4 )
    ItemExamineUI::ItemExamineUI(v4, v1);
  else
    v5 = 0;
  v1->m_itemUI = v5;
  v6 = (BasicCreatureExamineUI *)operator new(0x94u);
  v7 = v6;
  if ( v6 )
  {
    BasicCreatureExamineUI::BasicCreatureExamineUI(v6, v1);
    v8 = v7->m_basicCreatureExamineBaseField;
    v7->vfptr = (ExamineSubUIVtbl *)&CreatureExamineUI::vftable;
    v7[1].vfptr = 0;
    if ( v8 )
      v7[1].vfptr = (ExamineSubUIVtbl *)UIElement::GetChildRecursive(v8, 0x1000014Eu);
  }
  else
  {
    v7 = 0;
  }
  v1->m_creatureUI = (CreatureExamineUI *)v7;
  v9 = (CharExamineUI *)operator new(0xA0u);
  if ( v9 )
    CharExamineUI::CharExamineUI(v9, v1);
  else
    v10 = 0;
  v1->m_charUI = v10;
  v11 = (SpellExamineUI *)operator new(0xA0u);
  if ( v11 )
    SpellExamineUI::SpellExamineUI(v11, v1);
  else
    v12 = 0;
  v1->m_spellUI = v12;
  UIListener::RegisterForGlobalMessage((UIListener *)&v1->vfptr, 3u);
  v13 = GlobalEventHandler::GetGlobalEventHandler();
  v14 = v13;
  if ( v13 )
  {
    v13->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v13, (unsigned int)&loc_4DD1E7, (NoticeHandler *)&v1->vfptr);
    v14->vfptr->RegisterNoticeHandler(
      (NoticeRegistrar *)v14,
      (unsigned int)((char *)&loc_4DD1EC + 1),
      (NoticeHandler *)&v1->vfptr);
    v14->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v14, (unsigned int)&loc_4DD1EE, (NoticeHandler *)&v1->vfptr);
    v14->vfptr->RegisterNoticeHandler(
      (NoticeRegistrar *)v14,
      (unsigned int)((char *)&loc_4DD1EE + 1),
      (NoticeHandler *)&v1->vfptr);
    v14->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v14, (unsigned int)&loc_4DD255, (NoticeHandler *)&v1->vfptr);
    v14->vfptr->RegisterNoticeHandler((NoticeRegistrar *)v14, 100008u, (NoticeHandler *)&v1->vfptr);
  }
  gmExaminationUI::SetActiveExamineUI(v1, (ExamineSubUI *)&v1->m_itemUI->vfptr);
}
// 7AF4D0: using guessed type void (__thiscall *CreatureExamineUI::vftable)(BasicCreatureExamineUI *this, unsigned __int32 _objid, struct ACCWeenieObject *);

//----- (004AD800) --------------------------------------------------------  // acclient.c:228715
void __thiscall gmExaminationUI::RecvNotice_ServerSaysMoveItem(gmExaminationUI *this, unsigned int _itemID, unsigned int _oldContainer, unsigned int _oldWielder, unsigned int _oldLocation, unsigned int _newContainer, int _place, unsigned int _newWielder, unsigned int _newLocation)
{
  IntrusiveHashTable<UIElement *,HashSetData<UIElement *> *,1>Vtbl *v9; // ecx@1

  v9 = this->m_hashElementsRegisteredWith.m_intrusiveTable.vfptr;
  if ( (void *(__thiscall *)(IntrusiveHashTable<UIElement *,HashSetData<UIElement *> *,1> *, unsigned int))_itemID == v9[1].__vecDelDtor )
    ItemExamineUI::SetInscriptionEditableState((ItemExamineUI *)v9);
}

//----- (004AD820) --------------------------------------------------------  // acclient.c:228725
void __thiscall AC1Legacy::PStringBase<char>::PStringBase<char>(AC1Legacy::PStringBase<char> *this, int i_int32)
{
  ...
  InterlockedIncrement(v3);
  AC1Legacy::PStringBase<char>::operator=(v2, i_int32);
}
// 8EE10C: using guessed type int AC1Legacy::PStringBase<char>::s_NullBuffer;

//----- (004AD850) --------------------------------------------------------  // acclient.c:228739
void __thiscall gmExaminationUI::~gmExaminationUI(gmExaminationUI *this)
{
  gmExaminationUI *v1; // esi@1
  ItemExamineUI *v2; // edi@1
  NoticeHandler *v3; // ebx@1
  BasicCreatureExamineUI *v4; // edi@3
  BasicCreatureExamineUI *v5; // edi@5
  SpellExamineUI *v6; // edi@7
  GlobalEventHandler *v7; // eax@9

  v1 = this;
  v2 = this->m_itemUI;
  v3 = (NoticeHandler *)&this->vfptr;
  this->vfptr = (IInputActionCallbackVtbl *)&gmExaminationUI::vftable;
  this->vfptr = (NoticeHandlerVtbl *)&gmExaminationUI::vftable;
  if ( v2 )
  {
    ItemExamineUI::~ItemExamineUI(v2);
    operator delete(v2);
  }
  v4 = (BasicCreatureExamineUI *)&v1->m_creatureUI->vfptr;
  v1->m_itemUI = 0;
  if ( v4 )
  {
    v4->vfptr = (ExamineSubUIVtbl *)&CreatureExamineUI::vftable;
    BasicCreatureExamineUI::~BasicCreatureExamineUI(v4);
    operator delete(v4);
  }
  v5 = (BasicCreatureExamineUI *)&v1->m_charUI->vfptr;
  v1->m_creatureUI = 0;
  if ( v5 )
  {
    v5->vfptr = (ExamineSubUIVtbl *)&CharExamineUI::vftable;
    BasicCreatureExamineUI::~BasicCreatureExamineUI(v5);
    operator delete(v5);
  }
  v6 = v1->m_spellUI;
  v1->m_charUI = 0;
  if ( v6 )
  {
    v6->vfptr = (ExamineSubUIVtbl *)&ExamineSubUI::vftable;
    AppraisalProfile::~AppraisalProfile(&v6->cur_prof);
    operator delete(v6);
  }
  v1->m_spellUI = 0;
  ...
  if ( v7 )
    v7->vfptr->UnRegisterAllNoticeHandlers((NoticeRegistrar *)v7, v3);
...
//----- (004AD930) --------------------------------------------------------  // acclient.c:228800
void __thiscall gmExaminationUI::SetTitleText(gmExaminationUI *this, const char *name, int stack)
{
  gmExaminationUI *v3; // ebp@1
  int v4; // esi@2
  AC1Legacy::PStringBase<char> *v5; // eax@5
  AC1Legacy::PStringBase<unsigned short> *v6; // eax@5
  ...
  const char *v13; // esi@17
  PStringBase<unsigned short> *v14; // eax@23
  const char *v15; // esi@23
  AC1Legacy::PStringBase<char> rhs; // [sp+Ch] [bp-Ch]@5
  AC1Legacy::PStringBase<char> v17; // [sp+10h] [bp-8h]@5
  AC1Legacy::PStringBase<char> result; // [sp+14h] [bp-4h]@5

  v3 = this;
  if ( this->m_displayedNameText )
  {
    v4 = stack;
    if ( stack <= 1 )
    {
      PStringBase<unsigned short>::PStringBase<unsigned short>((PStringBase<unsigned short> *)&name, 0, name);
      UIElement_Text::SetText(v3->m_displayedNameText, v14);
      v15 = name - 20;
      if ( !InterlockedDecrement((volatile LONG *)name - 4) && v15 )
        (**(void (__thiscall ***)(const char *, signed int))v15)(v15, 1);
    }
    else
    {
      stack = AC1Legacy::PStringBase<char>::s_NullBuffer;
      InterlockedIncrement((volatile LONG *)(AC1Legacy::PStringBase<char>::s_NullBuffer + 4));
      if ( !AC1Legacy::PStringBase<char>::convert((AC1Legacy::PStringBase<char> *)&stack, v4, 1) )
        AC1Legacy::PStringBase<char>::set((AC1Legacy::PStringBase<char> *)&stack, "???");
      AC1Legacy::PStringBase<char>::PStringBase<char>(&rhs, name);
      AC1Legacy::PStringBase<char>::PStringBase<char>((AC1Legacy::PStringBase<char> *)&name, " ");
      v5 = AC1Legacy::PStringBase<char>::operator+(
             (AC1Legacy::PStringBase<char> *)&stack,
             &result,
             (AC1Legacy::PStringBase<char> *)&name);
      v6 = (AC1Legacy::PStringBase<unsigned short> *)AC1Legacy::PStringBase<char>::operator+(v5, &v17, &rhs);
      AC1Legacy::PStringBase<unsigned short>::operator=((AC1Legacy::PStringBase<unsigned short> *)&stack, v6);
      v7 = v17.m_buffer;
      if ( !InterlockedDecrement((volatile LONG *)&v17.m_buffer->m_cRef) && v7 )
      ...
      v9 = name;
      if ( !InterlockedDecrement((volatile LONG *)name + 1) && v9 )
        (**(void (__thiscall ***)(const char *, signed int))v9)(v9, 1);
      v10 = rhs.m_buffer;
      if ( !InterlockedDecrement((volatile LONG *)&rhs.m_buffer->m_cRef) && v10 )
        v10->vfptr->__vecDelDtor((ReferenceCountTemplate<268435456,0> *)v10, 1u);
      v11 = stack;
      PStringBase<unsigned short>::PStringBase<unsigned short>(
        (PStringBase<unsigned short> *)&name,
        0,
        (const char *)(stack + 20));
      UIElement_Text::SetText(v3->m_displayedNameText, v12);
      v13 = name - 20;
      if ( !InterlockedDecrement((volatile LONG *)name - 4) && v13 )
        (**(void (__thiscall ***)(const char *, signed int))v13)(v13, 1);
...
//----- (004B60A0) --------------------------------------------------------  // acclient.c:234420
gmExaminationUI *__thiscall gmExaminationUI::scalar_deleting_destructor(gmExaminationUI *this, unsigned int a2)
{
  gmExaminationUI *v2; // esi@1
...
//----- (006F17A0) --------------------------------------------------------  // acclient.c:773741
void _E91_77()
{
  outside_val_69 = 1000.0 + 1.0;
}

//----- (006F17C0) --------------------------------------------------------  // acclient.c:773747
void _E93_53()
{
  block_length_69 = 24.0 * 8.0;
}

//----- (006F17E0) --------------------------------------------------------  // acclient.c:773753
void _E95_53()
{
  half_square_length_69 = 24.0 * 0.5;
}

//----- (006F1800) --------------------------------------------------------  // acclient.c:773759
int _E97_78()
{
  return atexit(_E98_90);
}

//----- (006F1810) --------------------------------------------------------  // acclient.c:773765
int _E100_71()
{
  return atexit(nullsub_810);
}

//----- (006F1820) --------------------------------------------------------  // acclient.c:773771
int _E103_63()
{
  return atexit(_E104_78);
}

//----- (006F1830) --------------------------------------------------------  // acclient.c:773777
void _E106_48()
{
  DEFAULT_VIEW_RADIUS_41 = 0.00019999999 * 3.0 + 0.1;
}

//----- (006F1850) --------------------------------------------------------  // acclient.c:773783
void _E108_35()
{
  MIN_QUANTUM_41 = 1.0 / 30.0;
}

//----- (006F1870) --------------------------------------------------------  // acclient.c:773789
void _E110_26()
{
  MAX_QUANTUM_41 = 1.0 / 5.0;
}

//----- (006F1890) --------------------------------------------------------  // acclient.c:773795
void _E112_43()
{
  PixelFormatDesc::PixelFormatDesc(&PixelFormatDesc_A8R8G8B8_76, PFID_A8R8G8B8);
}

//----- (006F18A0) --------------------------------------------------------  // acclient.c:773801
void _E118_36()
{
  LOWEST_DATA_RATE_79 = 1024;
}

//----- (006F18B0) --------------------------------------------------------  // acclient.c:773807
void _E120_25()
{
  HIGHEST_DATA_RATE_79 = 0x7FFF;
}

//----- (006F18C0) --------------------------------------------------------  // acclient.c:773813
int _E122_11()
{
  const int result; // eax@1

  result = LOWEST_DATA_RATE_79;
  INITIAL_MAX_DATA_RATE_27 = LOWEST_DATA_RATE_79;
  return result;
}

//----- (006F18D0) --------------------------------------------------------  // acclient.c:773823
int _E124_36()
{
  return atexit(_E125_43);
}

//----- (006F18E0) --------------------------------------------------------  // acclient.c:773829
unsigned int _E127_30()
{
  unsigned int result; // eax@1

  result = compute_str_hash("ID_Examine_Item_AugmentationCost");
  ID_Examine_Item_AugmentationCost = result;
  return result;
}

//----- (006F1900) --------------------------------------------------------  // acclient.c:773839
unsigned int _E129_16()
{
  unsigned int result; // eax@1

  result = compute_str_hash("EXPERIENCE");
  ID_AugmentationCost = result;
  return result;
}

//----- (006F1920) --------------------------------------------------------  // acclient.c:773849
int _E131_2()
{
  return atexit(_E132_60);
}

//----- (006F1930) --------------------------------------------------------  // acclient.c:773855
int _E134_3()
{
  return atexit(_E135_68);
}

//----- (006F1940) --------------------------------------------------------  // acclient.c:773861
int sub_6F1940()
{
  return atexit(nullsub_808);
}

//----- (00761170) --------------------------------------------------------  // acclient.c:888710
void __cdecl _E132_60()
{
  if ( (BasicCreatureExamineUI::m_rgTokens.m_sizeAndDeallocate & 0x80000000) == 0x80000000 )
    operator delete[](BasicCreatureExamineUI::m_rgTokens.m_data);
}

//----- (00761190) --------------------------------------------------------  // acclient.c:888717
void __cdecl _E135_68()
{
  if ( (dword_83F124 & 0x80000000) == 0x80000000 )
    operator delete[](BasicCreatureExamineUI::m_floatyRgTokens);
}
// 83F124: using guessed type int dword_83F124;
