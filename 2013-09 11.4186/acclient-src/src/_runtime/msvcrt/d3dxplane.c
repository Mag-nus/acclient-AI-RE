...
/* Module     : d3dxplane
   Object     : _runtime\msvcrt\d3dxplane.obj
   Functions  : 1
   Addresses  : 00607000 - 00607000 */
...
//----- (00607000) --------------------------------------------------------  // acclient.c:560641
void __stdcall AMDSSE_D3DXPlaneTransformArray(unsigned int pOut, unsigned int OutStride, unsigned int pV, unsigned int VStride, unsigned int pM, unsigned int n)
{
